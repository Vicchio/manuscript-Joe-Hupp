...
\begin{figure}[H]
    ...
    \caption{Diagram showing the assumed equilibria necessary to transform with \ce{H^{*}}, \ce{OH^{*}}, \ce{Ni^{*}} for the \textit{ab initio} thermodynamic analysis method. The assume assumed equilibria capture the reaction conditions influences on the stability of the metal cluster.}
...
%    \includegraphics{
%    }
    \caption{All the structures located on Figures \ref{fig:SI-phase-Ni-trans} and \ref{fig:SI-phase-Ni-fixed} are shown. The same naming convention and color scheme is used as the phase diagram figure.}
