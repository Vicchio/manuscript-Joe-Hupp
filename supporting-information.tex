...
\begin{equation}
    \Delta G^{0}(T,P,N_{H},N_{OH},N_{M}) \rightarrow \Delta G^{3}(T,P,\mu_{H^{*}},\mu_{OH^{*}},\mu_{M^{*}})
...
\begin{equation}
    \Delta G^{3}(T,P,\mu_{H^{*}},\mu_{OH^{*}},\mu_{M^{*}}) = \Delta G^{0}(T,P,N_{H},N_{OH},N_{M}) - (\mu_{H^{*}})(N_{H}) - (\mu_{OH^{*}})(N_{OH}) - (\mu_{M^{*}})(N_{OH})  
