...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Preliminary kinetic investigations related to the \ce{H2} adsorption and dissociation as well as proton migration along the cluster: 
        \begin{itemize}
            \item Does adsorption and dissociation prefer the following process: \ce{H2 + site -> 2H-site} (onto same site) or \ce{H2 + 2*site -> H-site + H-site} (onto different sites)? 
            ...
            \item How easily can the dissociated \ce{H} atoms move along cluster (what are the barrier behind this process)?
        \end{itemize}
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item The structure of \ce{Cu3(OH)4} complex is altered depending on the gas phase conditions. There exists the formation of physisorbed \ce{H2O} and \ce{Cu-H} species due to the dissociative adsorption of \ce{H2} (which has a larger driving forces as the gas phase, \ce{H2} partial pressure increases). 
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Rather than focusing on just \ce{Cu}-NU-1000 structures, we also explored \ce{Ni}-NU-1000. Our findings show similar structural features and suggest that in a reducing environment these supported metal complexes containing \ce{OH}-ligands are not stable.  
