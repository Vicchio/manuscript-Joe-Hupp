...
Curiously, our analysis does not find the \ce{Ni-H} active site species to 

\hl{I think the one aspect that I am still missing here now is the discussion on the active site species.. what is that species? NiH? OH? H2O? What are the options for those other species that could be the active site structure.}
