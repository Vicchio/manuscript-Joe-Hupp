...
\hl{dPDFs provide insights structural insights into the cluster by revealing key interatomic distances.} The dPDFs peaks are correlated interatomic distances between different atoms. The experimental dPDFs for the synthesized and activation of \ce{Ni(II)} cluster demonstrate key features related to the \ce{Ni-O} bond length, \ce{Ni...Ni} distance, and the \ce{Ni...Zr} distance.\cite{PlateroPrats2017} \citeauthor{PlateroPrats2017} observed a single \ce{Ni-O} peak (XXX) and splitting of both the \ce{Ni...Ni} (XXX and XXX) and (XXX and XXX) \ce{Ni...Zr} peaks, thus suggesting the formation of an asymmetric cluster.
