...
Combined experimental characterization and computational modeling has provided insights the active site structure for 3d transition metals supported on the standard NU-1000 MOF framework. The primary focus remains understanding the exact composition of the active site structure that are dependent on the number of metal species. Two primary models, that differ in the metal content , exist for the active site structure within the c-pore of NU-1000. A mononuclear (single-site) model was originally thought to be the active site structure.\hl{REFERNCE ALL THE EARLY SINGLE SITE PAPERS} However, the structure of the active site has been refined revealing that the metal species supported in the c-pore are more likely to be multinuclear (i.e., consisting of multiple metal species). Using difference envelope density (DED),\cite{Li2017} and differential pair distribution function (dPDF) analysis,\cite{PlateroPrats2017} the formation of multinuclear clusters within the c-pore has been established as the active site for NU-1000 for \hl{INSERT THE METAL SPECIES HERE}. Providing further insight to the active site structure for \ce{Ni} complexes, \citeauthor{PlateroPrats2017} suggest the formation of tetranuclear heterobimetallic nanowires spanning the length of the c-pore with the cluster attached to two nodes.\citeauthor{PlateroPrats2017} For \ce{Cu} complexes, \citeauthor{Ikuno2017} proposes a similar trinuclear structure that also spans the c-pore of NU-1000. \hl(NEED A CLOSING STATEMENT ABOUT THIS PARAGRAPH...something about what the active site structure actually is in this case..) 
...
Further complicating our understanding of the active site structure is the induced structural changes by the reaction environment during both the activation step and the reaction steps. The activation conditions, and therefore the structural changes, determine the reaction mechanism, such as \hl{dehydrogenation, hydrogenation, dimerization, oligomerization.} These types of transformations are common and required to investigate catalytic mechanisms. For ethylene hydrogenation, a \ce{Ni(II)} complex demonstrated \ce{Ni} cluster supported on NU-1000 demonstrated high activity and long-term stability.\cite{Li2016sintering} \citeauthor{Li2016sintering} proposes a mechanism on a mononuclear (single-site) \ce{Ni(II)} complex that is activated with \ce{H2} gas to form a \ce{Ni} hydride by removing a coordinated \ce{OH}-ligand.\cite{Li2016sintering} Expanding on the proposed \ce{H2} activation steps, mechanistic investigations into ethylene hydrogenation\cite{Shabbir2020} and propyne partial hydrogenation and isomerization\cite{Hackler2020} use a mononuclear model to high-throughout screen different metal species. The limitation of these findings is the usage of a mononuclear model when experimental characterization suggests that a multinuclear model is a more appropriate active site structure than the mononuclear model.


\begin{itemize}
    \item Under \ce{H2} environment, \citeauthor{Halder2020} experimentally demonstrated that above \SI{200}{Celsius} the trinuclear \ce{Cu(II)}-clusters supported on NU-1000 are reduced to zero-valent \ce{Cu(0)} species and stripped away from the node with the NU-1000 framework reverting back to the original unit cell dimensions.\cite{Halder2020} Conversely, when exposed to similar reducing conditions the \ce{Ni4(OH)6} complex shows only subtle structural variations up to 200 oC suggesting the cluster is stable under these conditions suggesting that the initial activation only produces subtle changes into the structure of the cluster.\cite{PlateroPrats2017}
    \item For the tetranuclear \ce{Ni(II)} cluster\cite{PlateroPrats2017}, \citeauthor{Ye2017} activated the \ce{Ni(II)} cluster with \ce{Et2AlCl} to remove \ce{OH}-ligands within the cluster as coordinate \ce{H2O}.\cite{Ye2017} Furthermore, the model activated structures are different depending on the spin of the \ce{Ni(II)} atoms.\cite{Ye2017}
    \item On the mononuclear \ce{Ni(II)} model, \citeauthor{Li2016sintering} 
    \item Need to talk about the new isomerization paper that I read.. 
\end{itemize}

(THERE IS A NEED TO NOT ONLY UNDERSTAND THE SYNTHESIZED STRUCTURE..BUT ALSO THE ACTIVE STRUCTURE). 
