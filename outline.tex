...
\begin{itemize}
    \item Paragraph 1: Gas-to-liquid transformations are difficult
    \begin{itemize}
        \item Challenging gas-to-liquid transformations provide opportunities to design catalysts to perform these reactions
        \item examples of different catalysts that are able to perform these transformations
    \end{itemize}
    \item Paragraph 2: Importance of understanding the active site structures for catalysis.
    \begin{itemize}
        \item The active site (metal species, coordinating ligands, steric environment) determine the reactivity and selectivity of the catalyst
        \item Rational catalyst design requires an understanding of the structure-function relationships of current catalysts
        \item Difficulties in determining the precise structure of the catalyst can poise significant limitations in catalyst design
        \item To better understand these catalytic transformations and design better catalysts, we need an understanding of the active site structure
    \end{itemize}
    \item Paragraph 3: General questions about the active site structure, and how the active site evolves as a function of reaction conditions
        \begin{itemize}
            ...
            \item Basic introduction to metal organic frameworks (inorganic node and organic linkers) 
            \item Statement about metal complex loading into the MOF framework (AIM and SALI), and how the metal loadings can vary under different conditions
            \item Different reaction condition induce structural changes for catalysts supported on MOFs
        \end{itemize}
...
We construct \ce{Ni} catalyst models within the the c-pore of NU-1000 (labeled in Figure~\ref{fig:Ni-MOF-model}b) that connects two adjacent \ce{Zr} nodes. Catalyst attachment to the node requires the loss of a proton in the \ce{OH/OH2} pair thereby giving the \ce{Ni} catalyst model a charge of $+$2 and the NU-1000 MOF a charge of $-$2. The \ce{Ni} catalyst models adopt a variety of compositions and comprise between two and four \ce{Ni} ions (denoted as \ce{Ni^{*}} in this work) as well as hydroxoyl (\ce{OH^{*}}), water, and hydride ligands. Water ligands are denoted as \ce{H2O^{*}}, indicating that a \ce{H} atom adsorbed onto \ce{OH^{*}}. Hydride ligands are denoted as \ce{H^{*}} indicating the formation of a \ce{Ni-H} on \ce{Ni^{*}}. In all, we evaluated \textbf{\color{red}XXX} structures; \textbf{\color{red}the full library can be accessed on our GitHub page.} 
...
\begin{equation}
    \mu_{\text{H}_{2}}^{\text{g}}(T,P_{\text{H}_{2}}) = E_{\text{H}_{2}}^{DFT} + \left[ G_{\text{H}_{2}}(T,P^{o}) - G_{\text{H}_{2}}(0~\text{K},P^{o}) + RT \ln{\left( \frac{P_{\text{H}_{2}}}{P^{o}} \right)} \right]  
    \label{eq:chemicalpotentialrel}
\end{equation}
$G$ in Eq.~\ref{eq:chemicalpotentialrel} are Gibbs free energies computed using the NASA Polynomials\cite{Mcbride1993} in the pMuTT\cite{LYM2019106864} Python package, $P$ is partial pressure, and the $o$ superscript on $P^{o}$ indicates standard pressure (1 bar). In Eq.~\ref{eq:chemicalpotentialrel}, $G(0~\text{K},P^{o})$ is calculated by extrapolating the NASA Polynomials to 10~K to correct the electronic energy of an isolated gas molecule with the temperature dependent free energy contributions. We create an analogous expression to Eq.~\ref{eq:chemicalpotentialrel} for $\mu_{\text{H}_{2}O}^{\text{g}}(T,P)$ (see \hl{supporting information}). The chemical potential of \ce{Ni} is approximated as the electronic energy of bulk \ce{Ni}, i.e., $\mu_\text{Ni} = E$. \hl{Further details about this approach are provided in Section XXXX of the Supporting Information.} The entire \textit{ab initio} \hl{thermodynamic process is outlined in details within the Supporting Information.}
