...
For ethylene hydrogenation, a \ce{Ni(II)} complex demonstrated \ce{Ni} cluster supported on NU-1000 demonstrated high activity and long-term stability.\cite{Li2016sintering} \citeauthor{Li2016sintering} proposes a mechanism on a mononuclear (single-site) \ce{Ni(II)} complex that is activated with \ce{H2} gas to form a \ce{Ni} hydride by removing a coordinated \ce{OH}-ligand.\cite{Li2016sintering}
