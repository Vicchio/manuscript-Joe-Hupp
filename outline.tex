...
\section{Methodology}
We investigate how reaction conditions, such as temperature ($T$) and pressure ($P$), influence the structure and composition of a \ce{Ni(II)} supported metal complex on NU-1000. \hl{Figure} \ref{fig:Ni-MOF-model} shows the NU-1000 MOF and the location of the \ce{Ni(II)} supported metal complex. The model consists of four \ce{Ni(II)} species located within the c-pore of NU-1000 (pore diameter of \hl{XXXX A}). Structurally, the \ce{Ni(II)} atoms are linked together by \ce{\mu3-OH} and \ce{\mu2-OH} ligands that connect adjacent \ce{Zr} nodes of the c-pore (\hl{Figure} \ref{fig:Ni-MOF-model} \hl{X})). Depending on conditions, \ce{Ni} may also be coordinated with adsorbed \ce{H2O} species.

\begin{figure}[H]
    \centering
%    \includegraphics{}
    \caption{Caption \hl{(the structure that we used here was considered our reference structure)}}
    \label{fig:Ni-MOF-model}
\end{figure}

We select the \ce{Ni4(OH)6} model shown in \hl{Figure} \ref{fig:Ni-MOF-model} \hl{X}) to be the reference structure for all chemical transformations. Under \ce{H2}, both the \ce{Ni(II)} and \ce{OH} ligands provide sites that can accept dissociated \ce{H} atoms after \ce{H2} adsorption and dissociation. When these sites, defined as \ce{OH^{*}} and \ce{Ni^{*}}, accept dissociated \ce{H} atoms, the composition of the cluster changes to include additional adsorbed \ce{H2O} (\ce{H2O^{*}}) and/or Nickel-hydride (\ce{Ni-H}). However, the adsorbed \ce{H2O} are not fixed to the \ce{Ni} cluster; our modeling include the subsequent desorption of \ce{H2O} into the gas-phase. All the aforementioned transformations are dependent on the reaction temperature ($T$), and the partial pressure of \ce{H2} ($P_{\text{\ce{H2}}}$) and \ce{H2O} ($P_{\text{\ce{H2O}}}$). We model the changes in cluster structure and composition as a function of these conditions by computing the free energy of compositionally different model structures  relative to a reference structure. We consider the chemical transformed described by the reversible reaction shown below (Equation \hl{XXX}):
\begin{equation}
    \begin{split}
        \ce{Ni4(OH)6 + z \cdot H2 (g) <=>} Ni4(OH)6 \cdot (6)H2O
    \end{split}
\end{equation}
\todo[inline]{Write the chemical equation that describes the transformations. If needed, check one of the old presentations for a description (maybe my Oral Qualifier?).}
(with respect to the number of \ce{H^{*}}, \ce{OH^{*}} and \ce{Ni^{*}} species)

Using \textit{ab initio} thermodynamic analysis, we transform the free energy from a fixed number of atoms ($N_{\text{i}}$) to a fixed chemical potential ($\mu_{\text{i}}$) to determine the stability of the different structural and compositional variations. The free energy is transformed with respect to $\mu_{\text{H}^{*}}$, $\mu_{\text{OH}^{*}}$, and $\mu_{\text{Ni}^{*}}$ to account for structural and compositional variations in the number of adsorbed \ce{H} species ($N_{\text{H}^{*}}$), \ce{OH}-ligands ($N_{\text{OH}^{*}}$), and \ce{Ni} species ($N_{\text{Ni}^{*}}$). Equation \ref{eq:free-energy-trans} shows the free energy difference ($\Delta F^{(3)}(T,\mu_{\text{H}^{*}},\mu_{\text{OH}^{*}},\mu_{\text{Ni}^{*}})$) between structure $\text{j}$ and the \ce{Ni4(OH)6} reference structure (ref).
\begin{equation}
    \begin{split}
...
% NEED A SECTION HERE THAT TALKS MORE ABOUT THE LIBRARY THAT WAS GENERATED

We evaluate the free energy at temperatures ($T$) ranging from 20 oC to 320 oC and \ce{H2} partial pressures ranging from $10^{-30}$ bar to $10^{0}$ at a fixed \ce{H2O} partial pressure. 

The free energy expression was solved at every combination of $T$, $P_{H_2}$, and $P_{H_{2}O}$ for all structures. We generate a library of unique, modified structures for the \textit{ab initio} thermodynamic analysis by systematically adding \ce{H} atoms to different atoms on metal cluster and then removing any formed \ce{H2O}. Each modified structure was optimized at each addition of \ce{H} atoms and removal of adsorbed \ce{H2O}. There are specific combinations of \ce{\text{H}^{*}}, \ce{OH^{*}} and \ce{M^{*}} within the library.
...
\section{Results}
We create phase diagrams that show the stability of different configurations and clusters as a function of $T$, $P_{\text{\ce{H2}}}$, and $P_{\text{\ce{H2O}}}$. At each set of conditions, the structure with the lowest free energy is identified and plotted to produce the phase diagram. The regions on the phase diagram correspond to a specific low energy structure, and at the interface between two regions the free energies values are the same. To reduce complexity, the phase diagrams show structural stability at a fixed partial pressure of $P_{\text{\ce{H2O}}} = 10^{-9}$ bar with the value selected to account for all \ce{H2O} removed at 100 oC. We expect a small value for \ce{H2O} partial pressure the activation conditions do not contain any \ce{H2O}. The only \ce{H2O} present on the cluster is from the initial hydration during synthesis or from the conversion of \ce{OH}-ligands into \ce{H2O} during the activation. The hydrated and dehydrated phase diagram for the \ce{Ni4(OH)6} cluster is located in the Supporting Information. 
...
%    \caption{
%    Phase diagram (a) and corresponding dPDF diagram (b) for the stability of the %\ce{Ni(II)} cluster as a function of temperature and \ce{H2} partial pressure %at a \ce{H2O} partial pressure = $10^{-9}$ bar when transforming with %\ce{\text{H}^{*}}, \ce{OH^{*}}, and \ce{Ni^{*}}. Regions in (a) indicate the the %modified structure that minimizes the free energy Equation %(\ref{eq:free-energy-trans}) at a given combination of $T/P_{H_{2}}$ and fixed %\ce{H2O} partial pressure. The \ce{H2} partial pressure is reported as %$log(P_{H_{2}}/P_{H_{2}}^{o})$, where the standard state is 1 atm. The dPDF %diagram (b) 
%    
%    
%    The following naming convention is adopted for the structures: 
...
We evaluate the performance of our model by comparing the dPDFs of the model structures to the experimental activation dPDF of \citeauthor{PlateroPrats2017} The dPDFs provide structural insights into the cluster by revealing key interatomic distances with peaks indicating the distance between different atoms. Experimentally, the significant dPDF peaks are the \ce{Ni-O} bond length at 2.02 A, the \ce{Ni \cdots Ni} distances at 3.01 A and 3.27 A, and the \ce{Ni \cdots Zr} distances at 3.78 A and 4.08 A. The experimental, activated dPDFs for \ce{Ni \cdots Ni} and \ce{Ni \cdots Zr} contain multiple peaks (hence the multiple distances), thus suggest the formation of an asymmetric cluster. Figure \ref{fig:dPDFs_TandP_trans_Ni} shows the dPDFs for all the thermodynamically favorable structures found in Figure \ref{fig:phase_diagram_Ni_combined} a). 

For the \ce{Ni-O} peak, we observe good agreement between the 1 cycle (activated) dPDF and the (1) \ce{Ni4(OH)6} (purple) (purple) dPDF. However, the other model structures either under predict ((4) \ce{Ni4(OH)4} (light blue), (5) \ce{Ni3(OH)2} (red), and (6) \ce{(NiH)2} (lilac)) or slightly over predict (\ce{Ni4(OH)6.41H2O} and (3) \ce{Ni4(OH)6.4H2O} (orange)) the \ce{Ni-O} distance. There is less agreement between the 1 cycle (activated) dPDFs and the model dPDFs for the \ce{Ni \cdots  Ni} and \ce{Ni \cdots Zr} split peaks. None of the model structures recreate the split peaks for \ce{Ni \cdots  Ni} and \ce{Ni \cdots Zr}. (1) \ce{Ni4(OH)6} (purple), \ce{Ni4(OH)4.4H2O} and (4) \ce{Ni4(OH)4} (light blue) show a broad \ce{Ni \cdots Ni} peak between 3.01 A and 3.27 A rather than two distinct \ce{Ni \cdots Ni} peaks. There is no agreement for (6) \ce{(NiH)2} (lilac) and (5) \ce{Ni3(OH)2} (red) compared to the 1 Cycle (activated) dPDF for the \ce{Ni \cdots Ni} peaks. Additionally, (4) \ce{Ni4(OH)4} (light blue) contains a small peak around 2.29 A that is attributed to another \ce{Ni \cdots Ni} distance (\hl{see support information}). Again, none of the model structures are able to recreate the split \ce{Ni \cdots Zr} split peaks. (1) \ce{Ni4(OH)6} (purple) and 
(3) \ce{Ni4(OH)6.4H2O} (orange) contain a single peak centered between the two \ce{Ni \cdots Zr} split break bounds. (2) \ce{Ni4(OH)6.H2O} (gray) and (4) \ce{Ni4(OH)4} (light blue) also exhibit a single peak; however, this peak is centered around the lower \ce{Ni \cdots Zr} split peak bound. For (5) \ce{Ni3(OH)2} (red) and (6) \ce{(NiH)2} (lilac), there are no peaks within the \ce{Ni \cdots Zr} region. The (5) \ce{Ni3(OH)2} (red) peak at 3.63 A is the \ce{Ni \cdots Zr} peak. 
...
We again evaluate the performance of our model system by comparing the model dPDFs to the experimental 1 cycle (activated) dPDF by comparing peaks across all structures (Figure \ref{fig:dPDFs_TandP_fixed_Ni}). First, we find that all model structures underpredict the \ce{Ni-O} bond length. Second, we find that as the cluster is reduced and \ce{OH^{*}} are removed a sharp peak appears between 2.1 A and 2.5 A. Inspecting the structures, the peak is related to a \ce{Ni \cdots Ni} distance between the two middle atoms of the cluster and is seen by \ce{Ni4(OH)4.H2O}, (8) \ce{(NiH2Ni)(Ni2)} (mint), \ce{Ni(NiOH)2(NiH2)}, and (10) \ce{Ni(NiH)2Ni(OH)2.H2O} (pink). The split \ce{Ni \cdots Ni} peaks are not captured by any of the thermodynamically dominate structures. However, \ce{Ni4(OH)4.H2O} and (8) \ce{(NiH2Ni)(Ni2)} (mint) show a single sharp peak centered around the split \ce{Ni \cdots Ni} peaks. Interestingly, (10) \ce{Ni(NiH)2Ni(OH)2.H2O} (pink) shows no peak within the 3.01 A to 3.27 A, but shows a prominent peaks associated to a \ce{Ni \cdots Ni} distance at 2.30 A and 2.71 A. (8) \ce{(NiH2Ni)(Ni2)} (mint) and (10) \ce{Ni(NiH)2Ni(OH)2.H2O} (pink) show a single peak within the bounds for the 1 Cycle (activated) \ce{Ni \cdots Zr} split peaks. (9)  \ce{Ni(NiOH)2(NiH2)} (green) weakly exhibits the split \ce{Ni \cdots Zr} peaks, but includes additional peaks at 2.20, 2.54, and 3.40 that are attributed to a \ce{Ni \cdots Ni} distance. For the \ce{Ni \cdots Zr}, (4) \ce{Ni4(OH)4} (light blue) shows a single peak at 3.81 A and (10) \ce{Ni(NiH)2Ni(OH)2.H2O} (pink) shows a single peak at 3.95 A. (8) \ce{(NiH2Ni)(Ni2)} (mint) show a single peak between the 1 Cycle (activated) peaks at 3.88 A, but also features an additional \ce{Ni \cdots Zr} peak at 3.17 A. (9)  \ce{Ni(NiOH)2(NiH2)} (green) shows two peaks of unequal height at 3.78 A and 4.00 A that are close to the peak positions of the 1 Cycle (activated) sample. \ce{Ni4(OH)4.H2O} shows \ce{Ni \cdots Zr} peak splitting; however, the splitting is shifted to lower positions at 3.66 A and 3.92 A. Overall, we observe peak splitting in a few structures, but fail to see an overall agreement with the 1 Cycle (activated) dPDFs from \citeauthor{PlateroPrats2017} 
...
Although not as pronounced, (11) \ce{Ni4(OH)4(O).3H2O} (green) demonstrates both \ce{Ni \cdots Ni} and \ce{Ni \cdots Zr} peak splitting. The upper bound for the \ce{Ni \cdots Ni} peak is shifted 3.35 A from 3.27 A. The \ce{Ni-O} peak for (11) \ce{Ni4(OH)4(O).3H2O} (green) matches the peak of 2.02 A of the 1 Cycle (activated). However, the \ce{Ni-O} peak for (11) \ce{Ni4(OH)4(O).3H2O} (green) is noticeably broader. The increased width is attributed to the adsorbed \ce{H2O} distance around 2.25 A. (12) \ce{Ni4(OH)4(O).2H2O} (light green) matches the \ce{Ni-O} distance, and does contain split \ce{Ni \cdots Ni} peaks that are shifted to lower distances relative to the 1 Cycle (activated). (12) \ce{Ni4(OH)4(O).2H2O} (light green) model does not demonstrate \ce{Ni \cdots Zr} peak splitting, but does contain a single peak at the lower \ce{Ni \cdots Zr} limit. The (13) \ce{Ni4(OH)6.H2O} (blue) model contains a sharp peak at 2.04 A related to the \ce{Ni-O} distance, \ce{Ni \cdots Zr} splitting shifted to lower distances, and a single \ce{Ni \cdots Zr } peak within the bounds of \ce{Ni \cdots Zr} peak splitting. All of the structures do not contain a \ce{Ni \cdots Ni} peak between 2.1 A and 2.4 A, which was seen on a majority of the structures in Figure \ref{fig:phase_diagram_Ni_combined} and Figure \ref{fig:Ni-structure-diagram}. 
