...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \caption{The stability of adsorbed \ce{H2O} on the \ce{Ni(II)} cluster as a function of temperature and \ce{H2O} partial pressure. The regions identify structures with the lowest free energy, thereby demonstrating amount of \ce{H2O} on the cluster.}
...
%        \includegraphics{}
    ...
    \begin{figure}
        \centering
%        \includegraphics{}
        \caption{The stability of the \ce{Ni(II)} cluster at a function of temperature and \ce{H2} partial pressure at a \ce{H2O} partial pressure = $10^{-9}$ atm. The free energy expression includes all transformations (\ce{H^{*}}, \ce{OH^{*}} and \ce{M^{*}}). Regions indicate the the modified structure that minimizes the free energy Equation (\ref{eq:free-energy-trans}) at a given combination of $T/P_{H_{2}}$ and fixed \ce{H2O} partial pressure. The name convention utilized to label each region is used throughout. The \ce{H2} partial pressure is reported as $log(P_{H_{2}}/P_{H_{2}}^{o})$, where the standard state is 1 atm. Regions to the right of the dashed line identifies the region where \ce{Ni} nano-particle (NP) formation via the complete removal of all \ce{Ni} atoms is thermodynamically favorable.}
...
\begin{itemize}
    \item Paragraph 1:
    \begin{itemize}
        \item the metal complex structure is dependent on the reaction environment. 
        \item the changes show the removal of \ce{OH}-ligands as \ce{H2O}
    \end{itemize}
    \item Paragraph 2:
    \begin{itemize}
        \item The suggested model structure is the light blue structure, which shows that the mu3-OH ligands are removed here. Note that this structure does NOT show any Ni-H formation on the cluster. Also, comparing the work from Platero-prats this structure contains undercoordinated \ce{Ni-atoms} 
    ...
    \item Paragraph 3:
    \begin{itemize}
        \item There are features shown on the phase diagram that are not present on the most recent 
