...
\begin{itemize}
    \item Deposition of 3d transition metal atoms on MOF framework can occur in the vapor phase via atomic layer deposition (ALD) in MOFs (AIM) \hl{REFERENCE} and in condensed phase via solvothermal deposition in MOFs (SIM), \hl{REFERENCE} where the synthesis conditions regulate the active species material loading to generate more active site structures supported on the framework. Characterization of the metal actives sites is suppressed by the bulk framework structure, leading to unanswered questions about the precise structure of the active site. Determining the exact structure of the active site is further complicated by activation and reaction conditions that can induce structural and compositional changes on the cluster.\hl{REFERENCE}
    
    Given the nature of the synthesis conditions, there is always a question about the precise structure of the active site for metal complexes supported on MOFs because characterization of the metal actives sites is suppressed by the bulk framework structure. Therefore, combined experimental and computational investigations suggest the synthesized structure of the active site. \hl{Talk about how hard it was to determine the structure of the proton on the MOF framework... REFERENCE Planas 2014}
