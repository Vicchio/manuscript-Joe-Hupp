...
\begin{figure}
    \centering
%    \includegraphics{}
    \caption{The stability of the \ce{Ni(II)} cluster at a function of temperature and \ce{H2} partial pressure at a \ce{H2O} partial pressure = $10^-13$ atm.}
    \label{fig:my_label}
\end{figure}

The phase diagrams show the stability of the cluster as a function of reaction temperature and \ce{H2} partial pressure to  

The stability of \ce{Ni(II)} cluster under reducing conditions is shown in \hl{Figure XXXX)}.

The stability of the \ce{Ni(II)} cluster under reducing conditions is sho
\begin{itemize}
