...
\begin{itemize}
    \item Proton topology of the \ce{Zr6} node structure (\citeauthor{Planas2014}) $\rightarrow$ this was important in determining how the metal sites might be forming on the structure 
    \item List of all the different types of transition metals loaded onto the cluster
    \begin{itemize}
        \item \ce{Ni}: \citeauthor{Hackler2020}, 
        \item \ce{Cu}: \citeauthor{Baek2018}, \citeauthor{AbdelMageed2019}, \citeauthor{Hackler2020}
        \item \ce{Zn}: \citeauthor{Gallington2016}, \citeauthor{Hackler2020}
        \item \ce{Co}: \citeauthor{Li2017}, \citeauthor{Hackler2020}
