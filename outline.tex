...
% My feedback from Rachel suggested that the opening was too specific.. therefore.. I need to think more general here. 



\begin{itemize}
    % Sentence that talks about NG trends
    \item Catalysts are vital to the present and future of society, with currently 90\% of the world's consumer goods requiring a catalyst during manufacturing.\hl{(REFERENCE: Catalyst book!)}  Most industrially relevant catalysts are heterogeneous because of their robustness and ease of recovery. However, heterogeneous catalysts suffer from poorly defined active sites that inhibit molecular understandings of the catalysis and therefore the rational catalyst design.  development of industrial relevant catalysts troublesome and time-consuming.
    
    Alternatively, homogeneous catalysts contain well-defined active sites from isolated atoms 
    
    A potential solution involes 
    
    
    % Sentence about catalysis
