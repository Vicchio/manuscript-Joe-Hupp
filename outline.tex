...
% Rachel's comment was that this should be moved and included in the introduction of the manuscript
...
NU-1000 (Figure~\ref{fig:Ni-MOF-model}a) comprises zirconium oxide (\ce{Zr6(\mu_{3}-O)4(\mu_{3}-OH)4(H2O)4(OH)4}) nodes connected by pyrene linker molecules. The resulting crystal structure contains large hexagonal channels (31 {\AA}), triangular channels (10 {\AA}), and small pores (8 {\AA}) as shown in Figures~\ref{fig:Ni-MOF-model}a and~\ref{fig:Ni-MOF-model}b. DFT-optimized unit cell parameters are $a=b=40.611$ {\AA}, $c=15.990$ {\AA}, $\alpha=\beta=\ang{90}$, and $\gamma=\ang{60}$, in agreement with prior work.\cite{PlateroPrats2017} The choice to use a maximum of four \ce{Ni} is based off prior work, with \citeauthor{PlateroPrats2017} revealing the \ce{Ni(II)} cluster most likely consists of four \ce{Ni} atoms from difference envelope density (DED) analysis.\cite{PlateroPrats2017} Catalyst models are constructed within the the 8 {\AA} pore of NU-1000 (Figure~\ref{fig:Ni-MOF-model}b) following prior work.\cite{PlateroPrats2017} Here, the \ce{Ni} clusters attach to NU-1000 by replacing protons on the NU-1000 \ce{Zr} nodes.\cite{Ortuno2016} Figure ~\ref{fig:Ni-MOF-model} (c) and (d) show structures consisting of four \ce{Ni} atoms anchored to adjacent nodes within the 8 {\AA} pore of NU-1000, as suggested by \citeauthor{Ye2017}\cite{Ye2017} Catalyst models adopt a variety of ligand environments that include hydroxyl (\ce{OH}), water (\ce{H2O}), hydride (\ce{H}), and oxygen (\ce{O}) ligands. 

\begin{figure}[H]
    \centering
    \includegraphics[width=5.0in]{zi-images/00-General-Graphics/2022-figure-clusters-3xstructures.png}
    \caption{
    Different variations of the \ce{Ni} cluster are shown in (a), (b), and (c) with the node of the MOF framework truncated from the renderings. All adsorbed \ce{H2O} molecules are outlined in blue. The reference structure for \textit{ab initio} thermodynamic analysis is shown in (a). The diverse ligand \ce{Ni} coordination environments are present with \ce{Ni} coordinating \ce{H2O} and \ce{OH} ligands (all structures), \ce{H} ligands (b), and \ce{O} ligands (c). 
    }
    \label{fig:Ni-MOF-structures}
\end{figure}

In all, we evaluated \textbf{\color{red}XXX} structures; \textbf{\color{red}the full library can be accessed on our GitHub page.} Beginning with a reference structure (\hl{Figure XXX} (a)), additional protons were added. We then considered removing all combinations of coordinated \ce{H2O} ligands repeated the process. The final library consisted of \hl{XXX} structures, which are within \hl{100 kJ/mol} of the lowest energy structure.  
...
Both $E^\text{ZP}$ and $F^\text{vib}$ are calculated using frequency calculations in the CP2K software package. The vibrational modes for the cluster were only considered by fixing the organic linkers and inorganic nodes, thereby calculating only the \ce{Ni} cluster vibrational contributions to the free energy ($F^\text{vib}$). We ensure that the same atoms are fixed across all frequency calculations in order to correctly compare ($F^\text{vib}$). When constructing the vibrational partition function, all frequencies less than 50 cm\textsuperscript{-1} are replaced with 50 cm\textsuperscript{-1} to correct for the breakdown in the harmonic oscillator approximation for low frequency vibrational modes.\cite{Ribeiro2011} The partitions functions are computed in the pMuTT\cite{LYM2019106864} Python package. A sample input file for the CP2K frequency calculations is provided in the Supporting Information.
...
To provide insight into the types of structures and compositions that could be observed experimentally, phase diagrams were constructed for $P_{\text{\ce{H2}}}$ spanning from ultrahigh vacuum to ambient and temperatures spanning from 20~\degree C to 300~\degree C in Figure~\ref{fig:phase_diagram_Ni_combined}. Specifically, Figure~\ref{fig:phase_diagram_Ni_combined} plots the thermodynamically preferred structures at (a) $P_{\text{\ce{H2O}}} = 10^{-10}$ bar and (b) $P_{\text{\ce{H2O}}} = 10^{-1}$ bar. The structures represented on the phase diagrams are hence those that minimize $F^{(2)}$ at the specified conditions (defined by $T$, $P_{\text{\ce{H2}}}$, and $P_{\text{\ce{H2O}}}$). The sensitivity of $P_{\text{\ce{H2O}}}$ selection on \textit{ab initio} thermodynamic analysis is provided \hl{in the Supporting Information}. Depictions illustrating the compositions and roughly the structures of these structures are shown in Figure~\ref{fig:Ni-structure-diagram}. Additionally, full structural information is provided \hl{in the Supporting Information}. The structures on the phase diagrams exhibit different compositions and including $\ce{OH}$, $\ce{H2O}$, and $\ce{H}$ ligands coordinated to the \ce{Ni} atoms.
...
\begin{figure}[H]
    ...
    \caption{
    Phase diagrams for the \ce{Ni} cluster calculated at (a) $P_{\ce{H2O}}=10^{-1}$ and (b) $P_{\ce{H2O}}=10^{-10}$ as a function of $T$ and $P_{\ce{H}_2}$. The different structures are represented by the different colored and numbered regions; the color and numbering schemes are the same as in Figures~\ref{fig:Ni-structure-diagram} and \ref{fig:dPDFs_TandP_trans_Ni}. The white $\otimes$ represents $T$ and $P_{\text{\ce{H2}}}$ conditions the cluster  is exposed to experimentally.
    }
...
With increasing \ce{H2} partial pressures, Figure~\ref{fig:phase_diagram_Ni_combined} (a) and (b) yield different thermodynamic minimum. Specifically, considering the phase diagram in Figure~\ref{fig:phase_diagram_Ni_combined} (a), at temperatures above ~220 \degree C, increasing $P_{\ce{H2}}$ results in the conversion of \ce{OH} to \ce{H2O}; the \ce{H2O} that form can then desorb, resulting in a loss of ligands. The largest difference between the structures  in Figures~\ref{fig:phase_diagram_Ni_combined} (a) and (b) is observed under these conditions. At \ce{H2} partial pressures above $10^{-6}$ bar and temperatures above 220 \degree C, structures 2-\ce{Ni4} (gray) and 3-\ce{Ni4(H)4} (purple) appear on Figure~\ref{fig:phase_diagram_Ni_combined} (a), which contain a low \ce{Ni} coordination (Figure~\ref{fig:Ni-structure-diagram}). Experimentally, the \ce{Ni} coordination for this system was observed to be much higher than the coordination demonstrated by structures 2-\ce{Ni4} (gray) and 3-\ce{Ni4(H)4} (purple). Both 2-\ce{Ni4} (gray) and 3-\ce{Ni4(H)4} (purple) exhibit a complete loss of all \ce{OH} and \ce{H2O} coordination ligands, which is not seen experimentally by \citeauthor{PlateroPrats2017}\cite{PlateroPrats2017} There are no \ce{Ni-O} bonds within the \ce{Ni} cluster for these two structures. 
...
dPDF analysis provides further insight into the structure and composition of the \ce{Ni} catalysts. We compare the dPDFs of all structures present on Figures~\ref{fig:phase_diagram_Ni_combined} (a) and (b) to the dPDF from the experimental structure (black line) as shown in Figure~\ref{fig:dPDFs_TandP_trans_Ni}. Key peaks in the experimentally observed dPDF are the single peak at 2.02 {\AA}, split peaks at 3.01 {\AA} and 3.27 {\AA}, and split peaks at 3.78 {\AA} and 4.08 {\AA}. These correspond to \ce{Ni-O}, \ce{Ni{\Compactcdots}Ni}, and \ce{Ni{\Compactcdots}Zr} distances, respectively. Our analysis primarily focuses on the \ce{Ni-O} and \ce{Ni{\Compactcdots}Ni} seen in the experimental dPDF. Both 2-\ce{Ni4} (gray) and 3-\ce{Ni4(H)4} (purple) in Figure~\ref{fig:phase_diagram_Ni_combined} (a) show no agreement with the experimental dPDF (shown in Figure~\ref{fig:dPDFs_TandP_trans_Ni}) because of the missing \ce{H2O} and \ce{OH} ligands. The lower coordination and lack of dPDF agreement supports our selection of a higher \ce{H2O} partial pressure as shown in Figure~\ref{fig:phase_diagram_Ni_combined} (b). We focus our analysis towards higher the phase diagram at higher \ce{H2O} partial pressure. 

At higher \ce{H2O} partial pressure, we observe structures with coordination numbers much closer to those observed experimentally. We observe larger \ce{Ni} coordination in Figure~\ref{fig:phase_diagram_Ni_combined} (b) than in Figure~\ref{fig:phase_diagram_Ni_combined} (a) as demonstrated by structures with more \ce{H2O} and \ce{OH} ligands present (Figure~\ref{fig:Ni-structure-diagram}). The only structures that appear on both Figure~\ref{fig:phase_diagram_Ni_combined} (a) and (b) are 4-\ce{Ni4(OH)4.2H2O} (orange) and 5-\ce{Ni4(OH)3(H).1H2O} (magenta) albeit under a difference set of conditions. Of interest is the catalyst composition and structure under operating conditions. Figure~\ref{fig:phase_diagram_Ni_combined} (b) shows the most energetically preferred structure is structure 4-\ce{Ni4(OH)4.2H2O} (orange) with the white $\otimes$ represents the conditions ($T$ and $P_{\text{\ce{H2}}}$) the \ce{Ni} cluster is exposed to under operating conditions. experimentally. Structure 4-\ce{Ni4(OH)4.2H2O} (orange) contains two coordinating \ce{H2O} ligands to the middle \ce{Ni} atoms, with the \ce{Ni} atoms linked by \ce{OH} ligands. This structure still contains \ce{H2O} ligands in the structure, while at a \ce{Ni-O} coordination number between 3 and 4. 

Figure~\ref{fig:dPDFs_TandP_trans_Ni} shows the dPDF for 4-\ce{Ni4(OH)4.2H2O} (orange), which features peaks at 2.00 {\AA} (\ce{Ni-O}), 2.54 {\AA} (\ce{Ni{\Compactcdots}Ni}), and 3.34 {\AA} (\ce{Ni{\Compactcdots}Ni}). The \ce{Ni{\Compactcdots}Ni} peak at 2.54 {\AA} is not seen on the experimental dPDF in Figure~\ref{fig:dPDFs_TandP_trans_Ni}, which suggests that the increased coordination of the \ce{Ni} atoms is vital in the atomic configuration of the \ce{Ni} cluster. A similar observation is made for 5-\ce{Ni4(OH)3(H).1H2O} (magenta), with the peak positions not agreeing with the experimental dPDF in Figure~\ref{fig:dPDFs_TandP_trans_Ni}. For structure 5-\ce{Ni4(OH)3(H).1H2O} (magenta), the \ce{Ni-O} peak position occurs at 1.91 {\AA} compared to the 2.00 {\AA} \ce{Ni-O} peak seen in the experimental dPDF. The low \ce{Ni} coordination reduces the atomic distances between the \ce{Ni} and \ce{O} atoms in the \ce{H2O} and \ce{OH} ligands. There is a lack of agreement between the model dPDFs for 4-\ce{Ni4(OH)4.2H2O} (orange) and 5-\ce{Ni4(OH)3(H).1H2O} (magenta) compared to the experimental dPDFs. We next considered structures at low \ce{H2} partial pressures on Figure~\ref{fig:phase_diagram_Ni_combined}.

At \ce{H2} partial pressures below $10^{-17}$ bar, we observe structures 6-\ce{Ni4(OH)6.2H2O} (cyan) and 7-\ce{Ni4(OH)6.3H2O} (teal) that contain the same base \ce{Ni4(OH)6} cluster with different \ce{H2O} content. In the \ce{Ni4(OH)6} cluster, the first coordination sphere of the \ce{Ni} atoms is comprised \ce{OH} and \ce{H2O} ligands with \ce{OH} ligands forming links between \ce{Ni} atoms and \ce{H2O} binding on the ``open" sites of the \ce{Ni} ions in the center of the chain. Under these conditions, the \ce{Ni} is coordinated by 5 or 6 ligands, which is supported by the \ce{Ni-O} coordination numbers of 5.4 reported by \citeauthor{PlateroPrats2017}\cite{PlateroPrats2017} The dPDFs for 6-\ce{Ni4(OH)6.2H2O} (cyan) and 7-\ce{Ni4(OH)6.3H2O} (teal) (shown in Figure~\ref{fig:dPDFs_TandP_trans_Ni}). The dPDF for 6-\ce{Ni4(OH)6.2H2O} (cyan) shows good agreement with the experimental dPDF for first \ce{Ni-O} peak, while only containing a single \ce{Ni{\Compactcdots}Ni} peak that is centered between the two experimental \ce{Ni{\Compactcdots}Ni} peaks. The dPDF for 7-\ce{Ni4(OH)6.3H2O} (teal) shows similar agreement with the first \ce{Ni-O} peak, and contains an single \ce{Ni{\Compactcdots}Ni} peak. As expected, we observe much better agreement between model structures and the experimental dPDF with structures that feature higher \ce{Ni} coordination. However, we fail to preciously recreate the experimental dPDF with the structures from \textit{ab initio} thermodynamic analysis. 

A closer inspection of the split peaks in the experimental dPDF at 3.01 {\AA} and 3.27 {\AA} suggests asymmetry in the \ce{Ni} coordination environments. Most structures appearing on the phase diagram (Figure~\ref{fig:phase_diagram_Ni_combined}) are symmetric in their ligand coordination (as showed by the structures located in Figure~\ref{fig:Ni-structure-diagram}). The symmetry in ligand the ligand environment results in symmetric interatomic distances between the different \ce{Ni} species, thereby leading to single peaks \ce{Ni{\Compactcdots}Ni} instead of multiple \ce{Ni{\Compactcdots}Ni} in the 3.01 {\AA} and 3.27 {\AA} range. Our library included structure with asymmetric \ce{Ni} coordination (\hl{as shown in the Supporting information}; however, these structures were not thermodynamic mimima under any explored conditions in \textit{ab initio} thermodynamic analysis. 

% paragraph about the dPDFs
Continuing with this idea, we evaluate all structures in our structure library to identify structures that might show better agreement of the \ce{Ni-O} peak and \ce{Ni{\Compactcdots}Ni} split peaks of the experimental dPDF. One such structure is 8$^{\blacklozenge}$-\ce{Ni4(OH)4)(O).3H2O} (yellow) (shown Figures~\ref{fig:Ni-structure-diagram} and \ref{fig:dPDFs_TandP_trans_Ni}). Structure 8$^{\blacklozenge}$-\ce{Ni4(OH)4)(O).3H2O} (yellow) is not a thermodynamic minimum under any of the explored conditions, hence why it does not appear on Figure~\ref{fig:phase_diagram_Ni_combined}. This structure exhibits a broad \ce{Ni-O} peak that agrees with the experimental dPDF and split \ce{Ni{\Compactcdots}Ni} peaks that show reasonable agreement. The structure displays a mixture of \ce{OH}, \ce{H2O}, and \ce{O} ligands, and high \ce{Ni} coordination as shown in Figure~\ref{fig:Ni-structure-diagram}. This asymmetric ligand environment breaks the symmetry of coordination, leading to the split to the split \ce{Ni{\Compactcdots}Ni} peaks at distances that closely reasonable those seen in the experimental dPDFs. We observe similar asymmetries in other structures (\hl{see Supporting information}) that show good agreement with the \ce{Ni-O} and \ce{Ni{\Compactcdots}Ni} peaks positions \hl{(see Supporting Information)}. The observed asymmetries include both diversity in the \ce{Ni} coordination environment (\ce{OH}, \ce{H2O}, \ce{O}) as well as the orientation of certain ligands (mainly, \ce{H2O}). 

% Ni...Zr split peaks
The last remaining feature of the dPDFs not explored are the \ce{Ni{\Compactcdots}Zr} split peaks seen in the 3.78 {\AA} and 4.08 {\AA} range in the experimental dPDF (Figure~\ref{fig:dPDFs_TandP_trans_Ni}). Similar to the \ce{Ni{\Compactcdots}Ni} split peaks, most structures on the phase diagram (Figure~\ref{fig:phase_diagram_Ni_combined} exhibit a single peak within the experimental range of the \ce{Ni{\Compactcdots}Zr} peaks. Even structure 8$^{\blacklozenge}$-\ce{Ni4(OH)4)(O).3H2O} (yellow) fails to create the split \ce{Ni{\Compactcdots}Zr} peaks, although this structure does exhibit a broad \ce{Ni{\Compactcdots}Zr} peaks. The \ce{Ni{\Compactcdots}Zr} distance within the MOF is from the attachment of the Nickel SSHC to the MOF node. The \ce{Ni} atoms are connected to the \ce{Zr} via \ce{OH} ligands within our model, so single peaks suggests that distances between the two \ce{Ni} and \ce{Zr} atoms are uniform. To exhibit asymmetry, we expect that either the two \ce{Ni} ions that connect to the \ce{Zr} nodes will have coordination environments that differ from each other or that the NU-1000 unit cell exhibits asymmetry around the c-pore under reaction conditions. For example, the experimentally observed \ce{Ni{\Compactcdots}Zr} split peaks could be caused by node distortions (i.e., deformations in the MOF crystalline structure). As presently formulated, our model fails to consider any deformations of the MOF crystalline structure. Our unit cell parameters are fixed throughout the entire simulation. As the unit cell dimensions and shapes are held fixed in our models, our models are better able to capture asymmetry due to different ligand environments, but not due to structural effects of the MOF itself. Possible deviations include different coordinating ligands between the two atoms, such as was explored by \citeauthor{Shabbir2020} on a single atom Nickel catalyst.\cite{Shabbir2020} We did consider variations to the ligands that coordinate directly to the MOF node (\ce{Zr}) and the Nickel SSHC (\ce{Ni}). However, these structures were not thermodynamic minima under any of the explored conditions.

In general, the simulated structures tend to give good agreement with the \ce{Ni-O} peak when compared to the experimental peak. The \ce{Ni-O} peak corresponds to the first coordination shell of the \ce{Ni} atoms; as long as \ce{OH} and \ce{H2O} ligands are present we observe reasonable agreement between the model and experimental \ce{Ni-O} peak. For the \ce{Ni{\Compactcdots}Ni} split peaks, the local coordination of the \ce{Ni} atoms has more of an influence when comparing the simulated and experimental peaks. The \ce{Ni{\Compactcdots}Ni} peaks are from the second coordination shell of the \ce{Ni} atoms. The \ce{Ni{\Compactcdots}Ni} interatomic distances are more sensitive to the ligand environment of the \ce{Ni} atoms compared to the \ce{Ni-O} interatomic distances. None of the structures from \textit{ab initio} thermodynamic analysis recreate the \ce{Ni{\Compactcdots}Ni} peak positions; however, we identify alternative structures (e.g., structures that are not thermodynamic mimima under any explored conditions) that show reasonable agreement for both the \ce{Ni-O} peak and \ce{Ni{\Compactcdots}Ni} peaks. These structures exhibit \ce{Ni} coordination environments consisting of \ce{OH} and \ce{H2O} ligands that are asymmetric around the \ce{Ni} atoms. Despite considering these alternative structure, we were unable to find any structure containing well defined \ce{Ni{\Compactcdots}Ni} peaks, suggesting that our model is unable to capture these specific split peaks. 
...
Of the structure represented in Figures~\ref{fig:phase_diagram_Ni_combined} (a) and (b), only structures \hl{7-XXX} and \hl{8-XXX} at the higher \ce{H2O} partial pressure exhibit \ce{Ni} coordination environments in agreement with experimental coordination. Figure~\ref{fig:dPDFs_TandP_trans_Ni} shows good agreement for the \ce{Ni-O} peak when comparing \hl{7-XXX} and \hl{8-XXX} to the experimental dPDF (black line); however, neither structure recreates the split \ce{Ni{\Compactcdots}Ni} peaks. Instead of the split peaks, \hl{7-XXX} and \hl{8-XXX} exhibit a single \ce{Ni{\Compactcdots}Ni} peak. Our modeling suggests that split \ce{Ni{\Compactcdots}Ni} peaks occur via asymmetries in the \ce{Ni} coordination environment.

Hence, to provide further insight into the ligand composition of the observed structure, we searched our structural database for structures that more closely matched the experimental dPDF. The structure from our library that gave the best agreement with the experimental dPDFs is 8$^{\blacklozenge}$-\ce{Ni4(OH)4)(O).3H2O} (yellow), shown in Figures~\ref{fig:Ni-structure-diagram} and ~\ref{fig:dPDFs_TandP_trans_Ni}. It should be noted that this structure is not a thermodynamic minimum, according to our analysis, which is why it does not appear on the phase diagram. The composition of structure 8-\hl{XXX}$^{\blacklozenge}$-\ce{Ni4(OH)4(O).3H2O} (green) is both compositional diverse and asymmetric with ligand coordination. This structure comprises of \ce{OH} and \ce{H2O} ligands, and additionally includes a \ce{\mu_{2}-O} ligand instead of a \ce{\mu_{2}-OH} ligand. The \ce{Ni} coordination is such that the $\ce{OH}$ and $\ce{O}$  ligands link adjacent two \ce{Ni} atoms. Additionally, an $\ce{H2O}$ ligand occupies the space of a $\ce{OH}$ ligand (i.e., the $\ce{H2O}$ ligand is coordinated to two \ce{Ni} atoms). The structure features high \ce{Ni} coordination, which as previously discussed, is an important characteristic of structures resemble the experimental structure. A similar observation is based on alternative structures in the SI, with an \ce{H2O} ligand occupy the space of a \ce{\mu_{3}-OH} ligand (i.e., an \ce{OH} ligand coordinated to 3 \ce{Ni} atoms). Generally, structures that exhibit high \ce{Ni} coordination with he compositional diverse and asymmetric ligand \ce{Ni} coordination show the best agreement with the experimental dPDFs.

Given that the structure dPDF that best agrees with the experimental dPDF contains the compositional diverse (\ce{OH}, \ce{H2O}, and \ce{O} ligands) and asymmetric \ce{H2O} ligand occupying a `defect' site and \ce{O} ligand coordinating two \ce{Ni} atoms) ligand coordination suggests that considering alternative structures is important. Although not as pronounced, the \hl{yellow} structure also exhibits \ce{Ni{\Compactcdots}Zr} peak splitting. While this structure still does not reproduce the experimental dPDF, 8$^{\blacklozenge}$-\ce{Ni4(OH)4)(O).3H2O} (yellow) provides clues as to the composition and structure of the \ce{Ni} cluster under catalytic operating conditions. Specifically, this structure is likely to comprise at least four \ce{Ni} atoms with high coordination that involves diverse ligand coordination. 
