...
Environmental conditions have a profound effect on SSHC active site structure. Responsive structural transformations for SSHCs include sintering of the metal atoms,\hl{REF-} dispersion of the metal atoms,\hl{REF-} or changes in the local coordination environment.\hl{REF-} The local coordination environment has a strong influence on the chemical reactivity. Determining the precise SSHC active site structure, which is already challenging, is exacerbated by the influence of environmental conditions. Combined experimental and computational approaches address SSHC active site characterization questions when exposed to different environmental conditions. For example, \hl{DeRita2019} demonstrates that local coordination of \ce{Pt} atoms deposited on \ce{TiO2} nanoparticles evolve in response to environmental conditions and elucidates how these structural changes strongly influence the chemical reactivity for \ce{CO} oxidation.\hl{DeRita2019} Conversely, environmental conditions can also fundamentally alter the active site structure from an SSHC to encapsulated nanoparticles in MOFs.\hl{Halder2020,Mian2020} The diverse nature of SSHCs is further complicated when trying to predict how environmental conditions might alter a specific SSHC structure. \hl{MAYBE DISCUSS HOW SIMILAR METAL COMPLEXES IN MOFS WITH DIFFERENT ATOMS GENERATE DIFFERENT ACTIVE SITE}


Therefore, systemically addressing how the local coordination environment changes in responses to variations in environmental conditions is essential when determining structure-function relationships for SSHCs regardless of the support. 

For SSHCs supported on MOFs, both temperature \hl{REF-} and gas phase species\hl{REF-} are known to influence the active site structure for supported metal complexes.\hl{REF-} 


Therefore, our work addresses how the ligand coordination environment changes  

ongoing questions remain about how the local coordination environment the supported metal complex responds to environmental conditions.  with varying  

%\hl{Zhu2020} --> different intermediate form as a function of the reaction conditions

% Last sentence or two can talk about the assumptions of H2O removal in MOFs.

Our work investigates how environmental conditions (temperature and gas phase) influence the structure of  
...
MOFs, a porous crystalline material formed from inorganic nodes interconnected by organic linkers,\cite{Furukawa2013,Li1999} are commonly used to support 3d transition metal complexes to form SSHCs.\cite{Cui2018,Noh2016,Li2017,Song2019,Nguyen2015,Hackler2020} Metal complexes, comprised of metal atoms (e.g., \ce{Ni(II)}) and coordinating ligands (e.g., \ce{OH}/\ce{OH2}), generate the active site species. For SSHCs supported on MOFs, both temperature \hl{REF-} and gas phase species\hl{REF-} are known to influence the active site structure for these supported metal complexes.\cite{PlateroPrats2017b,Rimoldi2017}
