...
\begin{figure}[H]
    ...
    \caption{
    Different variations of the \ce{Ni} cluster are shown in (a), (b), and (c) with the node of the MOF framework truncated from the renderings. All adsorbed \ce{H2O} molecules are outlined in blue. \hl{We adopt the following naming convention to for the structures, and use a similar naming convention throughout the manuscript.}
    }
