...
We evaluate the performance of our model by comparing the dPDFs of the model structures to the experimental activation dPDF of \citeauthor{PlateroPrats2017}. The dPDFs provide structural insights into the cluster by revealing key interatomic distances with peaks indicating the distance between different atoms. Experimentally, the significant dPDF peaks are the \ce{Ni-O} bond length at 2.02 A, the \ce{Ni \cdots Ni} distances at 3.01 A and 3.27 A, and the \ce{Ni \cdots Zr} distances at 3.78 A and 4.08 A. The experimental, activated dPDFs for \ce{Ni \cdots Ni} and \ce{Ni \cdots Zr} contain multiple peaks (hence the multiple distances), thus suggest the formation of an asymmetric cluster. Figure \ref{fig:dPDFs_TandP_trans_Ni} shows the dPDFs for all the thermodynamically favorable structures found in Figure \ref{fig:phase_diagram_Ni_combined} a). For the \ce{Ni-O} peak, we observe that the good agreement between the 1 cycle (activated) dPDF and the \ce{Ni4(OH)6} (purple) dPDF. However, the other model structures either under predict (\ce{Ni4(OH)4}, \ce{Ni3(OH)2}, and \ce{(NiH)2}) or over predict (\ce{Ni4(OH)6 \cdot 4H2O}) the \ce{Ni-O} distance. 

There is less agreement between the 1 cycle (activated) dPDFs and the model dPDFs for the \ce{Ni \cdots  Ni} and \ce{Ni \cdots Zr} split peaks. None of the model structures recreate the split peaks for \ce{Ni \cdots  Ni} and \ce{Ni \cdots Zr}. \ce{Ni4(OH)6}, \ce{Ni4(OH)4 \cdot 4H2O} and \ce{Ni4(OH)4} show a broad \ce{Ni \cdots Ni} peak between 3.01 A and 3.27 A rather than two distinct \ce{Ni \cdots Ni} peaks. There is no agreement for \ce{(NiH)2} and \ce{Ni3(OH)2} compared to the 1 Cycle (activated) dPDF. Additionally, \ce{Ni4(OH)4} contains a small peak around 2.29 A that is attributed to another \ce{Ni \cdots Ni} distance (\hl{see support information}). Again, none of the model structures are able to recreate the split \ce{Ni \cdots Zr} split peaks. \ce{Ni4(OH)6} and 
\ce{Ni4(OH)6 \cdot 4H2O} contain a single peak centered between the two \ce{Ni \cdots Zr} split break bounds. \ce{Ni4(OH)6 \cdot H2O} and \ce{Ni4(OH)4} also exhibit a single peak; however, this peak is centered around the lower \ce{Ni \cdots Zr} split peak bound. For \ce{Ni3(OH)2} and \ce{(NiH)2}, there are no peaks within the \ce{Ni \cdots Zr} region. The \ce{Ni3(OH)2} peak at 3.63 A is the \ce{Ni \cdots Zr} peak. 
...
We again evaluate the performance of our model system by comparing the model dPDFs to the experimental 1 cycle (activated) dPDF by comparing peaks across all structures (Figure \ref{fig:dPDFs_TandP_fixed_Ni}). First, we again observe that all model structures underpredict the \ce{Ni-O} bond length. Second, we find that as the cluster is reduced and \ce{OH^{*}} are removed a sharp peak appears between 2.1 and 2.5 A. The peak is related to a \ce{Ni \cdots Ni} distance between the two middle atoms of the cluster and is seen by \ce{Ni4(OH)4 \cdot H2O}, \ce{(NiH2Ni)(Ni2)}, \ce{Ni(NiOH)2(NiH2)}, and \ce{Ni(NiH)2Ni(OH)2 \cdot H2O}. The split \ce{Ni \cdots Ni} peaks are not captured by any of the thermodynamically dominate structures. However, \ce{Ni4(OH)4 \cdot H2O} and \ce{(NiH2Ni)(Ni2)} show a single sharp peak centered around the split \ce{Ni \cdots Ni} peaks. Interestingly, \ce{Ni(NiH)2Ni(OH)2 \cdot H2O} shows no peak within the 3.01 A to 3.27 A, but shows a prominent peaks associated to a \ce{Ni \cdots Ni} distance at 2.30 A and 2.71 A. \ce{(NiH2Ni)(Ni2)} and \ce{Ni(NiH)2Ni(OH)2 \cdot H2O} show a single peak within the bounds for the 1 Cycle (activated) \ce{Ni \cdots Zr} split peaks. \ce{Ni(NiOH)2(NiH2)} weakly exhibits the split \ce{Ni \cdots Zr} peaks, but includes additional peaks at 2.20, 2.54, and 3.40 that are attributed to a \ce{Ni \cdots Ni} distance. For the \ce{Ni \cdots Zr}, 

\ce{Ni4(OH)4} shows a single peak at 3.81 A and \ce{Ni(NiH)2Ni(OH)2 \cdot H2O} shows a single peak at 3.95 A. \ce{(NiH2Ni)(Ni2)} show a single peak between the 1 Cycle (activated) peaks at 3.88 A, but also features an additional \ce{Ni \cdots Zr} peak at 3.17 A. \ce{Ni(NiOH)2(NiH2)} shows two peaks of unequal height at 3.78 A and 4.00 A that are close to the peak positions of the 1 Cycle (activated) sample. \ce{Ni4(OH)4 \cdot H2O} shows \ce{Ni \cdots Zr} peak splitting; however, the splitting is shifted to lower positions at 3.66 A and 3.92 A. Overall, we observe peak splitting in a few structures, but fail to see an overall agreement with the 1 Cycle (activated) dPDFs from \citeauthor{PlateroPrats2017}
