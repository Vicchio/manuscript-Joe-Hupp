...
\begin{itemize}
    \item Deposition of 3d transition metal atoms on MOF framework can occur in the vapor phase via atomic layer deposition (ALD) in MOFs (AIM) \hl{REFERENCE} and in condensed phase via solvothermal deposition in MOFs (SIM). \hl{REFERENCE} 
