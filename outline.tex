...
%Structures that can achieve such high \ce{Ni} coordination exhibit large chemical potentials of \ce{H2O} even under reducing conditions, suggesting that Ni-NU-1000 is able to store \ce{H2O} under these conditions.
...
%The split peaks may also arise due to different ligand environments on the \ce{Zr} ions, which we have not explored computationally.
