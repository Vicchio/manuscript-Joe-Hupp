...
To provide insight into the types of structures and compositions that could be observed experimentally, phase diagrams were constructed for $P_{\text{\ce{H2}}}$ spanning from ultrahigh vacuum to ambient and temperatures spanning from 20~\degree C to 300~\degree C in Figure~\ref{fig:phase_diagram_Ni_combined}. Specifically, Figure~\ref{fig:phase_diagram_Ni_combined}  plots the thermodynamically preferred structures at (a) $P_{\text{\ce{H2O}}} = 10^{-10}$ bar and (b) $P_{\text{\ce{H2O}}} = 10^{-1}$ bar. The structures represented on the phase diagrams are hence those that minimize $F^{(2)}$ at the specified conditions ($T$, $P_{\text{\ce{H2}}}$, and $P_{\text{\ce{H2O}}}$). Depictions illustrating the compositions and roughly the structures of these structures are shown in Figure~\ref{fig:Ni-structure-diagram}. Additionally, full structural information is provided \hl{in the Supporting Information}. The structures on the phase diagrams exhibit different compositions and including $\ce{OH}$, $\ce{H2O}$, and $\ce{H}$ ligands coordinated to the \ce{Ni} atoms.

With increasing \ce{H2} partial pressures, Figure~\ref{fig:phase_diagram_Ni_combined} (a) and (b) yield different thermodynamic minimum. Specifically, considering the phase diagram in Figure~\ref{fig:phase_diagram_Ni_combined} (a), at temperatures above ~220 \degree C, increasing $P_{\ce{H2}}$ results in the conversion of \ce{OH} to \ce{H2O}; the $\ce{H2O^{*}}$ that form can then desorb, resulting in a loss of ligands. The largest difference between the structures  in Figures~\ref{fig:phase_diagram_Ni_combined} (a) and (b) is observed under these conditions. At \ce{H2} partial pressures above $10^{-6}$ bar and temperatures above 220 \degree C, structures 2-\hl{XXX} and 3-\hl{XXX} appear on Figure~\ref{fig:phase_diagram_Ni_combined} (a), which contain a low \ce{Ni} coordination (Figure~\ref{fig:Ni-structure-diagram}). Experimentally, the \ce{Ni} coordination for this system was observed to be much higher than the coordination demonstrated by structures 2-\hl{XXX} and 3-\hl{XXX}. Both 2-\hl{XXX} and 3-\hl{XXX} exhibit a complete loss of all \ce{OH} and \ce{H2O} coordination ligands, which is not seen experimentally by \citeauthor{PlateroPrats2017}\cite{PlateroPrats2017} There are no \ce{Ni-O} bonds within the \ce{Ni} cluster for these two structures. 

dPDF analysis provides further insight into the structure and composition of the \ce{Ni} catalysts. We compare the dPDFs of all structures present on Figures~\ref{fig:phase_diagram_Ni_combined} (a) and (b) to the dPDF from the experimental structure (black line) as shown in Figure~\ref{fig:dPDFs_TandP_trans_Ni}. Key peaks in the experimental dPDF are the single peak \ce{Ni-O} at 2.02 {\AA}, and the split \ce{Ni{\Compactcdots}Ni} peaks at 3.01 {\AA} and 3.27 {\AA}. Both 2-\hl{XXX} and 3-\hl{XXX} in Figure~\ref{fig:phase_diagram_Ni_combined} (a) show no agreement with the experimental dPDF (shown in Figure~\ref{fig:dPDFs_TandP_trans_Ni}) because of the missing \ce{H2O} and \ce{OH} ligands. The lower coordination and lack of dPDF agreement supports our selection of a higher \ce{H2O} partial pressure (Figure~\ref{fig:phase_diagram_Ni_combined} (b)). We focus our analysis towards higher the phase diagram at higher $P_{\text{\ce{H2O}}}$. 

% paragraph about 4 and 5
At higher \ce{H2O} partial pressure, we observe structures with coordination numbers much closer to those observed experimentally. we observe larger \ce{Ni} coordination in Figure~\ref{fig:phase_diagram_Ni_combined} (b) than in Figure~\ref{fig:phase_diagram_Ni_combined} (a) as demonstrated by structures with more \ce{H2O} and \ce{OH} ligands present (Figure~\ref{fig:Ni-structure-diagram}). The only structures that appear on both Figure~\ref{fig:phase_diagram_Ni_combined} (a) and (b) are 4-\ce{Ni4(OH)4.2H2O} (orange) and 5-\hl{XXX} (magenta) albeit under a difference set of conditions. Figure~\ref{fig:phase_diagram_Ni_combined} (b) shows the most energetically preferred structure is structure 4-\ce{Ni4(OH)4.2H2O} (orange) with the white $\otimes$ represents the conditions ($T$ and $P_{\text{\ce{H2}}}$) the \ce{Ni} cluster is exposed to experimentally. Structure 4-\ce{Ni4(OH)4.2H2O} (orange) contains two coordinating \ce{H2O} ligands to the middle \ce{Ni} atoms, with the \ce{Ni} atoms linked by \ce{OH} ligands. This structure still contains \ce{H2O} ligands in the structure, while at a \ce{Ni-O} coordination number between 3 and 4. 

Figure~\ref{fig:dPDFs_TandP_trans_Ni} shows the dPDF for 4-\ce{Ni4(OH)4.2H2O} (orange), which features peaks at 2.00 {\AA} (\ce{Ni-O}), 2.54 {\AA} (\ce{Ni{\Compactcdots}Ni}), and 3.34 {\AA} (\ce{Ni{\Compactcdots}Ni}). The \ce{Ni{\Compactcdots}Ni} peak at 2.54 {\AA} is not seen on the experimental dPDF in Figure~\ref{fig:dPDFs_TandP_trans_Ni}, which suggests that the increased coordination of the \ce{Ni} atoms is vital in the atomic configuration of the \ce{Ni} cluster. A similar observation is made for 5-\hl{XXX} (magenta), with the peak positions not agreeing with the experimental dPDF in Figure~\ref{fig:dPDFs_TandP_trans_Ni}. 

% paragraph about 6 and 7 
At low \ce{H2} partial pressures (below $10^{-17}$ bar), we observe structures 6-\hl{XXX} (cyan) and 7-\hl{XXX} (teal) that contain the same base \ce{Ni4(OH)6} cluster with different \ce{H2O} content. In the \ce{Ni4(OH)6} cluster, the the first coordination sphere of the \ce{Ni} atoms is comprised \ce{OH} and \ce{H2O} ligands with \ce{OH} ligands forming links between \ce{Ni} atoms and \ce{H2O} binding on the ``open" sites of the \ce{Ni} ions in the center of the chain. Under these conditions, the \ce{Ni} is coordinated by 5 or 6 ligands, which is supported by the \ce{Ni-O} coordination numbers of 5.4 reported by \citeauthor{PlateroPrats2017}\cite{PlateroPrats2017} 

% paragraph about the dPDFs
The dPDFs for 6-\hl{XXX} (cyan) and 7-\hl{XXX} (teal) (shown in Figure~\ref{fig:dPDFs_TandP_trans_Ni}).  
...
% Paragraph talking about what structures are important on Figure (b) --> which can include some discussion on the waters present within the cluster.
