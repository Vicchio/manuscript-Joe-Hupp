...
In order to provide further molecular-level insight into the ligand environment of Ni-NU-1000, we generated d-PDFs for the remaining structures in the database (i.e., for the remaining structures not included in Figure~\ref{fig:phase_diagram_Ni}). The structures that give the best agreement with experiments are \ce{Ni4(OH)4(O).3H2O} (maroon), which is depicted in Figures~\ref{fig:Ni-MOF-structures}d and \ref{fig:Ni-structure-diagram}b, and \ce{Ni4(OH)6.1H2O} (teal), depicted in Figure~\ref{fig:Ni-structure-diagram}b. The d-PDFs for these structures are given in Figure~\ref{fig:dPDFs-graphic}c. The \ce{Ni4(OH)4(O).3H2O} (maroon) structure exhibits a single \ce{Ni-O} peak that is somewhat broader than the for the synthesized structure. It also exhibits split \ce{Ni{\Compactcdots}Ni} peaks like the synthesized structure, although their intensities are somewhat different. The \ce{Ni4(OH)4(O).3H2O} (maroon) structure exhibits a \ce{Ni-O} coordination number of 5.0 and a mixture of \ce{OH}, \ce{H2O}, and \ce{O} ligands. The ligand environment is asymmetric, leading to split \ce{Ni{\Compactcdots}Ni} peaks at distances in agreement with those observed experimentally. Comparatively, the \ce{Ni4(OH)6.1H2O} (teal) features a less asymmetric ligand environment compared to \ce{Ni4(OH)4(O).3H2O} (maroon) with a single \ce{H2O} ligand coordinated to one of the \ce{Ni} ions. Yet, the \ce{Ni4(OH)6.1H2O} (teal) structure exhibits a well-defined single \ce{Ni-O} peak and split \ce{Ni{\Compactcdots}Ni} peaks that have similar intensities. This suggests that even slight asymmetries in the coordination environment can lead to split \ce{Ni{\Compactcdots}Ni} peaks. Though these structures are not a thermodynamic minimum according to \textit{ab initio} thermodynamic analysis, we find that both structures compete with the phase space of \ce{Ni4(OH)6.2H2O} (cyan) structure in Figure~\ref{fig:phase_diagram_Ni}. The difference in free energy relative to the \ce{Ni4(OH)6.2H2O} (cyan) structure for \ce{Ni4(OH)4(O).3H2O} (maroon) structure is ~350 kJ/mol and for \ce{Ni4(OH)6.1H2O} (teal) is ~170 kJ/mol (Figure S\hl{XXX}). 

% INSERT PARAGRAPH HERE TALKING ABOUT COMBINING THE STRUCTURES SPLIT PEAKS
Alternatively, we also consider the possibility that the experimental d-PDF in Figure~\ref{fig:dPDFs-graphic}a is a combination of several structures that are similar in energy. Hence, we use Boltzmann weighting to combine d-PDFs using the free energy values at various positions on the phase diagram (details provided in \hl{Supporting Information Section XXX}). The Boltzmann weighted d-PDFs at various chemical potentials are presented in Figure S\hl{XXX}. We find that both \ce{Ni4(OH)4(O).3H2O} (maroon) and \ce{Ni4(OH)6.1H2O} (teal) structures do not appear in the Boltzmann weighted d-PDF presented in Figure S\hl{XXX}b. Under these conditions the d-PDF is dominated by the \ce{Ni4(OH)6.2H2O} (cyan) structure (Figure~\ref{fig:dPDFs-graphic}b). We also explore other regions on the phase diagram using Boltzmann weighting. Given that \ce{Ni4(OH)6.4H2O} (green) and \ce{Ni4(OH)6.3H2O} (purple) have different \ce{Ni{\Compactcdots}Ni} peak positions (seen in Figure~\ref{fig:dPDFs-graphic}b), we use Boltzmann weighting to combine the d-PDFs. 

combines structures that feature only a single \ce{Ni{\Compactcdots}Ni} peak


We consider combining the d-PDFs of \ce{Ni4(OH)6.4H2O} (green) and \ce{Ni4(OH)6.3H2O} (purple), given that the two structures have different \ce{Ni{\Compactcdots}Ni} peak positions in Figure~\ref{fig:dPDFs-graphic}b. 

We find that under certain conditions Boltzmann weighting structures combines structures that feature only a single \ce{Ni{\Compactcdots}Ni} peak


We find that under certain conditions Boltzmann weighting structures combines structures that feature only a single \ce{Ni{\Compactcdots}Ni} peak to produce a weighted d-PDF that exhibits split \ce{Ni{\Compactcdots}Ni} peaks (Figure~S\hl{XXX}x and XXX). The dominate structures in Figure~S\hl{XXX}x are \ce{Ni4(OH)6.4H2O} (green) and \ce{Ni4(OH)6.3H2O} (purple), which differ by a single \ce{H2O} ligand. Combining the d-PDFs of these two structures (shown in Figure~\ref{fig:dPDFs-graphic}b) generates the split \ce{Ni{\Compactcdots}Ni} peaks. The d-PDFs of structures that differ by a single \ce{H2O} were combined to generate a weighted d-PDF with split peaks. 

Likewise, a similar observation is observed in Figure~S\hl{XXX}d with both structures featuring a \ce{H2O} molecule chains. 

The structures are structural similar, with slight differences in the \ce{Ni} ligand coordination. The Boltzmann weighted d-PDFs suggest that disorder from \ce{Ni} cluster structure to structure might also lead to the split \ce{Ni{\Compactcdots}Ni} peaks, where energetically similar structures that differ slightly with respect to ligand coordination could combined to generate the experimental d-PDF.  


% --------------------------------------------------------------------------------

The last remaining feature of the d-PDFs not yet explored in this work is the \ce{Ni{\Compactcdots}Zr} peak. As for the \ce{Ni{\Compactcdots}Zr} peak, the synthesized structure exhibits split peaks whereas only one of the simulated structures exhibit a single peak. The exception is the \ce{Ni4(OH)4(O).3H2O} (maroon) structure; the structure has an asymmetric ligand environment and hence split peaks for distances involving \ce{Ni} are expected. The \ce{H2O} coordinated to two \ce{Ni} ions occupies a binding site of an \ce{\mu_{2}OH} ligand seen in the other structures (Figure~\ref{fig:Ni-structure-diagram}). Alternatively, the split peaks could be caused by unit cell asymmetry caused by node distortions, which has been previously observed for NU-1000 during \ce{Ni} deposition and under conditions relevant for catalytic hydrogenation.\cite{PlateroPrats2016} The split peaks may also arise due to different ligand environments on the \ce{Zr} ions, which we have not explored computationally.

Interestingly, only one structure comprising a \ce{Ni} hydride, i.e., structure \ce{Ni4(OH)5(H).4H2O} (blue), appears on the phase diagram. While this structure exhibits some characteristics in agreement with the synthesized structure, including split \ce{Ni{\Compactcdots}Ni} and \ce{Ni{\Compactcdots}Zr} peaks, it also exhibits split \ce{Ni-O} peaks, which is not observed experimentally, likely due to the significantly different ligand environment created by the hydride itself. These results suggest that the synthesized structure does not include a hydride. This could mean that the active site for hydrogenation catalysis is not a hydride, but rather a \ce{Ni} ion comprising \ce{OH} and/or \ce{H2O} ligands. Alternatively, it could mean that the \ce{Ni-H} is a transient species rather than a thermodynamic minimum. 
