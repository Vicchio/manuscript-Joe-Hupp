...
Again, we observe that structures 2-\ce{Ni4(OH)4} (blue) and 7-\ce{Ni4(OH)4.H2O} (yellow) again underpredict the coordination environment for the \ce{Ni}, while 8-\ce{Ni4(OH)5(H).4H2O} (teal) is contains reasonable \ce{Ni} coordination. Our analysis therefore suggests that even during exposure to \ce{H2} gas and increased temperature that \ce{H2O} still is present within the active site structure. The additional \ce{H2O} is necessary to maintain the high \ce{Ni} coordination. Therefore, we search the model structure library to find structures that more closely match the peak splitting observed experimental and \ce{Ni} coordination environment. 
