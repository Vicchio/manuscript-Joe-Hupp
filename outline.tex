...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{zi-images/01-Ni-Graphics/2021-04-01-Ni-single-dPDF.png}
    \caption{Caption}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics{zi-images/01-Ni-Graphics/2021-figure-atomic-structure.png}
    \caption{The atomic representation of 8-\ce{Ni4(OH)5(H).4H2O} (teal) is shown from the (a) top and (b) side-view. Integers label the different atoms within the structure. All \ce{H2O} are outlined in blue, and the blue non-integer numbers correspond to \ce{Ni-O} distances for the \ce{H2O}. Black, non-integer numbers correspond to the \ce{Ni-O} distances for the \ce{OH} ligands within the cluster.}
    \label{fig:atomic-distances-Ni}
\end{figure}
\todo[inline]{Not sure about my thoughts on this figure.}
