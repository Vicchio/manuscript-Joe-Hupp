...
Combined experimental characterization and computational modeling has provided insights the active site structure for 3d transition metals supported on the standard NU-1000 MOF framework. The primary focus remains understanding the exact composition of the active site structure that are dependent on the number of metal species. Two primary models for the c-pore, active site structure exist. The original model consists of a single metal species (mononuclear) attached to the node. \citeauthor{Li2016sintering} showed that a mononuclear \ce{Ni} cluster supported on NU-1000 demonstrated high activity and long-term stability.\cite{Li2016sintering} 
\begin{itemize}
    \item 
\end{itemize}
Additionally, molecular level insights provide a detailed understanding of the catalyic mechanisms for mononuclear species supported on MOFs.\hl{XXXX} 
\begin{itemize}
    \item \citeauthor{Shabbir2020} 
    \item 
\end{itemize}


However, the structure of the active site has been refined revealing that the metal species supported in the c-pore are more likely to be multinuclear. Using difference envelope density (DED),\cite{Li2017} and differential pair distribution function (dPDF) analysis,\cite{PlateroPrats2017} the formation of multinuclear clusters within the c-pore has been established as the active site for NU-1000. Providing further insight to the active site structure for \ce{Ni}, \citeauthor{PlateroPrats2017} suggest the formation of heterobimetallic nanowires spanning the length of the c-pore with the cluster attached to two nodes.\citeauthor{PlateroPrats2017}
...
Further complicating our understanding of the active site structure is the induced structural changes by the reaction environment during both the activation step and the reaction steps. The activation conditions, and therefore the structural changes, determine the reaction mechanism, such as \hl{dehydrogenation, hydrogenation, dimerization, oligomerization.} These types of transformations are common and required to investigate the catalytic mechanisms. For ethylene hydrogenation, \citeauthor{Li2016sintering} proposes a mechanism on a mononuclear (single-site) \ce{Ni(II)} complex that is activated with \ce{H2} gas to form a \ce{Ni} hydride by removing a coordinated \ce{OH}-ligand.\cite{Li2016sintering}  Expanding on the work of \cite{Li2016sintering}, mechanistic investigations into ethylene hydrogenation\cite{Shabbir2020} and propyne partial hydrogenation and isomerization\cite{Hackler2020} use a mononuclear model to high-throughout screen different metal species. The limitation of both findings is the presence of a single-site model when experimental characterization suggests that a multinuclear model is more appropriate active site structure.    


\begin{itemize}
    \item Under \ce{H2} environment, \citeauthor{Halder2020} experimentally demonstrated that above \SI{200}{Celsius} the trinuclear \ce{Cu(II)}-clusters supported on NU-1000 are reduced to zero-valent \ce{Cu(0)} species and stripped away from the node with the NU-1000 framework reverting back to the original unit cell dimensions.\cite{Halder2020}
