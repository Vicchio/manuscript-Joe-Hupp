...
\begin{figure}[H]
    ...
    \caption{
    The stability of the \ce{Ni(II)} cluster as a function of temperature and \ce{H2} partial pressure at a \ce{H2O} partial pressure = $10^{-9}$ atm when transforming with a)
    ...
    (2) \ce{Ni4(OH)6 \cdot H2O},      % gray
    (3) \ce{Ni4(OH)6 \cdot 4H2O},     % orange
    (4) \ce{Ni4(OH)4},                % light blue
    (5) \ce{Ni3(OH)2},                % red
    (6) \ce{(NiH)2},                  % lilac
    (7) \ce{Ni4(OH)4 \cdot H2O},      % yellow
    (8) \ce{(NiH2Ni)(Ni2)},           % mint
    (9)  \ce{Ni(NiOH)2(NiH2)}, and    % green 
    (10) \ce{Ni(NiH)2Ni(OH)2 \cdot H2O}. % pink
    }
    \label{fig:phase_diagram_Ni_combined}
\end{figure}   

The cluster is fully transformed with respect to composition of $\ce{H^{*}}$, $\ce{OH^{*}}$, and $\ce{Ni^{*}}$, and the low energy structures are plotted in Figure \ref{fig:phase_diagram_Ni_combined} a). Figure \ref{fig:phase_diagram_Ni_combined} a) shows that increasing \ce{H2} partial pressure decreases the $\ce{Ni^{*}}$ and $\ce{OH^{*}}$  composition of the cluster. The \ce{Ni4(OH)6 \cdot 4H2O} structure (orange) is the full hydrated \ce{Ni4(OH)6} cluster, which becomes the partially hydrated \ce{Ni4(OH)6 \cdot H2O} structure (gray) and then the dehydrated \ce{Ni4(OH)6} structure (purple) with increasing temperature. At temperatures above 130 oC, the thermodynamically dominate structure shifts from \ce{Ni4(OH)6} (purple) to \ce{Ni4(OH)4} (light blue) to \ce{Ni3(OH)2} (red) to \ce{(NiH)2} (lilac) with increasing \ce{H2} partial pressure. The transition from \ce{Ni4(OH)6} to \ce{Ni4(OH)4} occurs via the loss of \ce{\mu_{3}-OH} ligands because of the exposure to \ce{H2} gas during the activation conditions. The transition from \ce{Ni4(OH)4} to \ce{Ni3(OH)2} coincides with the further loss of \ce{\mu_{2}-OH} ligands and a single \ce{Ni} atom. The transition from \ce{Ni3(OH)2} to \ce{(NiH)2} demonstrates the further loss of \ce{\mu_{2}-OH} ligands and a single \ce{Ni} atom to produce a complex that is not attached to two nodes of NU-1000. The activate site now consists of two isolated \ce{Ni-H} metal complexes. We further evaluated the removal of the entire complex, which revealed that under the conditions shown in Figure \ref{fig:phase_diagram_Ni_combined} the global thermodynamic minimum is the NU-1000 MOF support without any \ce{Ni} supported metal complex.
...
We evaluate the performance of our model by comparing the dPDFs of the model structures to the experimental activation dPDF of \citeauthor{PlateroPrats2017}. The dPDFs provide structural insights into the cluster by revealing key interatomic distances with peaks indicating the distance between different atoms. Experimentally, the significant dPDF peaks are the \ce{Ni-O} bond length at \hl{XXX}, the \ce{Ni \cdots Ni} distances at \hl{XXX} and \hl{XXX}, and the \ce{Ni \cdots Zr} distances at \hl{XXX} and \hl{XXX}. The experimental, activated dPDFs for \ce{Ni \cdots Ni} and \ce{Ni \cdots Zr} contain multiple peaks (hence the multiple distances), thus suggest the formation of an asymmetric cluster. Figure \ref{fig:dPDFs_TandP_trans_Ni} shows the dPDFs for all the thermodynamically favorable structures found in Figure \hl{XXX}. For the \ce{Ni-O} peak, we observe that the good agreement between the 1 cycle (activated) dPDF and the \ce{Ni4(OH)6} (purple) dPDF. However, the other model structures either under predict (\ce{Ni4(OH)4}, \ce{Ni3(OH)2}, and \ce{(NiH)2}) or over predict (\ce{Ni4(OH)6 \cdot 4H2O}) the \ce{Ni-O} distance. There is less agreement between the 1 cycle (activated) dPDFs and the model dPDFs for the \ce{Ni \cdots  Ni} and \ce{Ni \cdots Zr} split peaks. None of the model structures recreate the split peaks for \ce{Ni \cdots  Ni} and \ce{Ni \cdots Zr}. \ce{Ni4(OH)6}, \ce{Ni4(OH)4 \cdot 4H2O} and \ce{Ni4(OH)4} show a broad \ce{Ni \cdots Ni} peak between \hl{XXX} and \hl{XXX} rather than two distinct \ce{Ni \cdots Ni} peaks. There is no agreement for \ce{(NiH)2} and \ce{Ni3(OH)2} compared to the 1 Cycle (activated) dPDF. Additionally, \ce{Ni4(OH)4} contains a small peak around \hl{XXX} A that is attributed to another \ce{Ni \cdots Ni} distance (\hl{see support information}).  \citeauthor{PlateroPrats2017} found the \ce{Ni} coordination environment to decrease slightly from 5.4 under activation conditions.\cite{PlateroPrats2017} The model structures (\hl{REFERENCE-STRUCTURE-FIGURE}) fail to match the experimentally observed coordination environment. Therefore, we explore the stability of the cluster with a fixed \ce{Ni^{*}} composition.
...
The cluster is now transformed with respect to composition of $\ce{H^{*}}$ and $\ce{OH^{*}}$ (Figure \ref{fig:phase_diagram_Ni_combined} b)). Unlike Figure \ref{fig:phase_diagram_Ni_combined} a), Figure \ref{fig:phase_diagram_Ni_combined} b) contains a fixed \ce{Ni^{*}} composition. \ce{Ni4(OH)6 \cdot 4H2O}, \ce{Ni4(OH)6 \cdot H2O}, \ce{Ni4(OH)6}, and \ce{Ni4(OH)4} appear on both (Figure \ref{fig:phase_diagram_Ni_combined} a) and b); however, the structures now appear on the diagram are \ce{Ni4(OH)4 \cdot H2O} (yellow), \ce{(NiH2Ni)(Ni2)} (mint), \ce{Ni(NiOH)2(NiH2)} (green), and \ce{Ni(NiH)2Ni(OH)2 \cdot H2O} (pink). A similar trend is observed in Figure \ref{fig:phase_diagram_Ni_combined} b) as \ref{fig:phase_diagram_Ni_combined} a); the continued conversion of \ce{\mu_{2}-OH^{*}} sites into \ce{H2O} with increasing \ce{H2} partial pressure. Starting from \ce{Ni4(OH)4}, the lowest energy structures exhibit the replacement of \ce{\mu_{2}-OH} ligands with \ce{Ni-H-Ni} structural units. \ce{Ni(NiOH)2(NiH2)} shows the partial conversion of and \ce{(NiH2Ni)(Ni2)} shows the full conversion of the \ce{\mu_{2}-OH} ligands that link the \ce{Ni} atoms of the cluster. 


At lower temperatures, adsorbed \ce{H2O} is found in the lowest energy structures (\ce{Ni4(OH)4 \cdot H2O} and \ce{Ni(NiH)2Ni(OH)2 \cdot H2O}). 

We again evaluate the performance of our model system by comparing the model dPDFs to the experimental 1 cycle (activated) dPDF by comparing peaks across all structures (Figure \ref{fig:dPDFs_TandP_fixed_Ni}). First, we again observe that all model structures underpredict the \ce{Ni-O} bond length. Second, we find that as the cluster is reduced and \ce{OH^{*}} are removed a sharp peak appears between 2.1 and 2.5 A. The peak is related a \ce{Ni \cdots Ni} distance between the two middle atoms of the cluster and is seen by \ce{Ni4(OH)4 \cdot H2O}, \ce{(NiH2Ni)(Ni2)}, \ce{Ni(NiOH)2(NiH2)}, and \ce{Ni(NiH)2Ni(OH)2 \cdot H2O}. The split \ce{Ni \cdots Ni} peaks are not captured by any of the thermodynamically dominate structures. However, \ce{Ni4(OH)4 \cdot H2O} and \ce{(NiH2Ni)(Ni2)} show a single sharp peak centered around the split \ce{Ni \cdots Ni} peaks. Interestingly, \ce{Ni(NiH)2Ni(OH)2 \cdot H2O} shows no peak within the \hl{XXX} to \hl{XXX}, but shows a prominent peak associated to a \ce{Ni \cdots Ni} distance at \hl{XXX} A. \ce{(NiH2Ni)(Ni2)} and \ce{Ni(NiH)2Ni(OH)2 \cdot H2O} show a single peak within the bounds for the 1 Cycle (activated) \ce{Ni \cdots Zr} split peaks. \ce{Ni(NiOH)2(NiH2)} weakly exhibits the split \ce{Ni \cdots Zr} peaks, but includes an additional peak at \hl{XXX} that is attributed to a \hl{XXX} distance.    
  

\ce{Ni \cdots  Ni} and \ce{Ni \cdots Zr}
...
% Fixed Ni content phase diagram
...
%\begin{figure}[H]
%    \centering
%%    \includegraphics{zi-images/01-Ni-Graphics/2021-figure-phase-diagram-Ni-fixe%d.png}
%    \includegraphics{zi-images/01-Ni-Graphics/2021-02-24-phase-diagram-updated-N%i-transformed-full-removal.png}
