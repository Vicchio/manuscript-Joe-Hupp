...
\begin{outline}
    ...
    \item Paragraph 2:
    \begin{itemize}
        \item The suggested model structure is the light blue structure, which shows that the \ce{\mu_3-OH} ligands are removed here. Note that this structure does NOT show any Ni-H formation on the cluster. Also, comparing the work from Platero-prats this structure contains undercoordinated \ce{Ni-atoms} 
