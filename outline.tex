...
% structure diagram for the special selection structures


% dPDF for the special-selection structures
\begin{figure}
    \centering
    \includegraphics{zi-images/01-Ni-Graphics/2021-03-03-Ni-special-selection-dPDFs-manuscript.png}
    \caption{
    Differential pair distribution functions (dPDFs) for select model structures that do not appear on Figure \ref{fig:phase_diagram_Ni_combined}. The structures shown above are not thermodynamic minimum. The naming convention is adopted: (11) \ce{Ni4(OH)6.4H2O} (green), (12) \ce{Ni4(OH)4(O).3H2O} (light green), and (13) \ce{Ni4(OH)6.1H2O} (blue)
    }
    \label{fig:dPDF-Ni-special}
\end{figure}

We searched the model structure library to find structures that might better reproduce the 1 (Cycled) activated dPDF. We found the following model structures to be structurally relevant: (11) \ce{Ni4(OH)6.4H2O} (green), (12) \ce{Ni4(OH)4(O).3H2O} (light green), and (13) \ce{Ni4(OH)6.1H2O} (blue). Although not at pronounced, (11) \ce{Ni4(OH)6.4H2O} (green) demonstrates both \ce{Ni \cdots Ni} and \ce{Ni \cdots Zr} peak splitting. The upper bound for the \ce{Ni \cdots Ni} peak is shifted 3.35 A from 3.27 A. The \ce{Ni-O} peak for (11) \ce{Ni4(OH)6.4H2O} (green) matches the peak of 2.02 A of the 1 Cycle (activated). However, the ce{Ni-O} peak for (11) \ce{Ni4(OH)6.4H2O} (green) is noticeably broader. The increased width is attributed to the adsorbed \ce{H2O} distance around 2.25 A. The (12) \ce{Ni4(OH)4(O).3H2O} (light green) model contains a unique structure and composition. A \ce{\mu_{2}-OH} ligand was replaced with an \ce{\mu_{2}-O} ligand. (12) \ce{Ni4(OH)4(O).3H2O} (light green) matches the \ce{Ni-O} distance, and does contain split \ce{Ni \cdots Ni} peaks that are shifted to lower distances relative to the 1 Cycle (activated). (12) \ce{Ni4(OH)4(O).3H2O} (light green) model does not demonstrate \ce{Ni \cdots Zr} peak splitting, but does contain a single peak at the lower \ce{Ni \cdots Zr} limit. The (13) \ce{Ni4(OH)6.1H2O} (blue) model contains a sharp peak at 2.04 A related to the \ce{Ni-O} distance, \ce{Ni \cdots Zr} splitting shifted to lower distances, and a single \ce{Ni \cdots Zr } peak within the bounds of \ce{Ni \cdots Zr} peak splitting. All of the structures do not contain a \ce{Ni \cdots Ni} peak between 2.1 A and 2.4 A, which was seen on a majority of the structures in Figure \ref{fig:phase_diagram_Ni_combined} and Figure \ref{fig:Ni-structure-diagram}
