...
\newpage
\section{Methodology}
% First paragraph about the different transformations of the cluster 
We demonstrate the influence of reaction conditions, such as temperature ($T$) and pressure ($P$), on a multinuclear \ce{Ni(II)} supported metal complex. The \ce{Ni(II)} complex (shown in Figure \ref{fig:ref_Ni4_structure}) is located within the small pore of NU-1000. Exposure to \ce{H2} gas induces structural and compositional changes to the cluster because of the presence of \ce{OH}- and \ce{M}-ligands provide sites for \ce{H2} adsorption and dissociation. The \ce{OH}- and \ce{M} sites accept \ce{H} atoms from \ce{H2} adsorption and dissociation to generate \ce{H2O} and \ce{Ni-H} species, respectively. The generated adsorbed \ce{H2O} species can desorb into the gas phase. All the aforementioned transformations are dependent on the reaction conditions, which includes the partial pressure of \ce{H2} ($P_{H_2}$), the partial pressure of \ce{H2O} ($P_{H_{2}O}$), and the reaction temperature ($T$). The dynamic changes in cluster structure and composition as a function of reaction conditions are modeled.

Specifically, \textit{ab initio} thermodynamic analysis computes the stability of structurally and compositionally different structures by transforming the free energy from a fixed number of atoms to a fixed chemical potential. 



The \ce{Ni(II)} complex features adsorbed \ce{OH^{*}} and \ce{M^{*}} species and, when activated with molecular \ce{H2}, forms \ce{H^{*}} species attached to either the \ce{OH^{*}} species forming waters (\ce{H2O^{*}}) or the \ce{M^{*}} species forming metal hydrides (\ce{M-H}).

The newly formed structure exhibits a different composition of \ce{H^{*}}, \ce{OH^{*}} and \ce{M^{*}} species relative to the reference structure, with the stability of the structure dependent on the reaction conditions. With \ce{H2} activation, the cluster stability is dependent on $T$ and  

There is a finite number of modified structures of the cluster when ac

\begin{figure}
    \centering
    %\includegraphics[width=0.85\textwidth]{}
    \caption{Structure of the multinuclear Ni(II) cluster supported on NU-1000. Initially proposed by XXX, the composition of the cluster is \ce{Ni4(\mu_2-OH)4(\mu_3-OH)2}. The structure is our reference for all \textit{ab initio} thermodynamic analysis calculations.}
    \label{fig:ref_Ni4_structure}
\end{figure}

We compared the free energy of structures that are compositionally different than the reference structure using \textit{ab initio} thermodynamic analysis. Fundamental to the approach is the transformation of the free energy from a fixed number of atoms ($N_i$) to a fixed chemical potential ($\mu_i$). We transform for the free energy with respect to ($\mu_{H^{*}}$, $\mu_{OH^{*}}$, and $\mu_{Ni^{*}}$) (Figure \ref{fig:FPT-process}). Equation \ref{eq:free-energy-trans} shows the generalized free energy expression (see Supporting Information for the full derivation).
\begin{equation}
    \begin{split}
...
\end{equation}
The $\Delta G(T,N_{H^{*}},N_{OH^{*}},N_{Ni^{*}})$ term is the difference in the modified structure and reference structure (defined here as the as-synthesized, starting MOF structure). The chemical potential terms,  $\mu_{H^{*}}$ and $\mu_{OH^{*}}$, depend on the temperature and gas phase reaction conditions because we assume that the adsorbate species are in equilibrium with an ideal-gas like reservoir with \ce{H2} and \ce{H2O} species (as shown in Figure \ref{fig:FPT-process}). The chemical potential of the reservoir is dependent on the reaction conditions ($T$ and $P$). At equilibrium, the chemical potential of the adsorbate species is equal to the chemical potential of the gas phase species. The assumed equilibrium for $\ce{H^{*}}$ is with $\frac{1}{2}\ce{H_{2}^{g}}$ and for $\ce{OH^{*}}$ is with $\ce{H_{2}O^{g}}$/$\frac{1}{2}\ce{H_{2}^{g}}$. The combined expression for $\ce{OH^{*}}$ captures the influence of both \ce{H2O} and \ce{H2} gas phase conditions on the stability of the cluster (further details in the Supporting Information). The metal chemical potential term ($\mu_{M^{*}}$) is independent of the reaction conditions and the metal chemical potential term is approximated by the electronic energy for a bulk metal system. Equation \ref{eq:chemicalpotentialeq} shows the chemical potential expressions for the $\ce{H^{*}}$ and $\ce{OH^{*}}$ adsorbed species with respect to gas phase \ce{H2} and \ce{H2O} conditions. 
\begin{equation}
    \begin{split}
...
\end{equation}
The $\mu_{i}^{g}(T,P)$ terms contain the temperature and pressure influences of the reaction conditions.
...
We generate a library of unique, candidate modified structures for the \textit{ab initio} thermodynamic analysis by systematically adding \ce{H} atoms to different atoms on metal cluster and removing any formed \ce{H2O} (\hl{see Supporting Information for further details}).




for all structures in the library. At every combination of $\mu_{H_{2}}^{g}(T,P)$ and $\mu_{H_{2}O}^{g}(T,P)$, the structure with the lowest free energy is identified to generate phase diagrams revealing the thermodynamic landscape of the modified metal cluster under reducing conditions. 
