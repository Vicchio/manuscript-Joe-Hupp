...
\newpage
\section{Free Energy Calculations...relating the important species}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.60\linewidth]{zi-images/04-SI-images-old-old/2021-05-04-Trans-Ni.png}
    \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.60\linewidth]{zi-images/04-SI-images-old/2021-05-04-Fixed-Ni.png}
    \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics{zi-images/04-SI-images-old/2021-05-11-updated-manuscript-structure-SI-ALL.png}
    \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics{zi-images/04-SI-images-old/2021-05-11-Ni-single-dPDF-ALL-SI-ALL.png}
    \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics{zi-images/04-SI-images-old/2021-05-10-Ni-single-dPDF-Ni-H.png}
    \caption{
...
\newpage
\section{Frequency Calculations}
