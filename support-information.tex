...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{ Increasing \ce{H2O}-Ligand Content of \ce{Ni4} Cluster}
...
\centering
  \setlength\tabcolsep{8pt}
  \caption{Water Selection Configuration}
  \label{tbl:water_selection_energies_cyan}
  \begin{tabular}{lcc}
    \hline
        Structure &  \thead{Electronic Energy \\ (hartree)} & \thead{$\Delta$Electronic \\ Energy (kJ/mol)} \\
        \hline
...
Table~\ref{tbl:water_selection_energies_purple} and \ref{tbl:water_selection_energies_cyan} show the relative energies of structures with the same overall stoichiometry, but different \ce{Ni_4} clusters. \ce{H2O}-ligands were moved from adjacent NU-1000 nodes to increase the \ce{H2O}-ligands present on the cluster (i.e., \ce{Ni4(OH)6.3H2O} (purple) is converted to \ce{Ni4(OH)6.4H2O}-config\_1 (green) and \ce{Ni4(OH)6.4H2O}-config\_2 (green), and \ce{Ni4(OH)6.2H2O} (cyan) is converted to \ce{Ni4(OH)6.3H2O}-config\_1 (purple) and \ce{Ni4(OH)6.3H2O}-config\_2 (purple)). Both Table~\ref{tbl:water_selection_energies_purple} and~\ref{tbl:water_selection_energies_cyan} show that moving an \ce{H2O}-ligand from the MOF node to increase the \ce{H2O}-ligand content on the \ce{Ni4} cluster is thermodynamically unfavorable. 
