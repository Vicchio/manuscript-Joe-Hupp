...
The conversion from a periodic \ce{Ni4} cluster to a gas phase \ce{Ni4} cluster is shown in Figure~\ref{fig:SI-cluster-gas-phase-schematic}. The electronic structure parameters for the gas phase \ce{Ni4} cluster calculations is the same as the computational parameters presented in SI S1.8. The unit cell for the gas phase parameters is expanded to a 50 {\AA} 50 {\AA} 50 {\AA} cubic box to represent the gas phase conditions. Table~\ref{tbl:alternate_model_energies_gas_phase} shows the $\Delta E_{\text{periodic}}$ calculated from periodic DFT calculations in CP2K and the $\Delta E_{\text{gas}}$ computed from the gas phase CP2K calculations. 
...
\begin{figure}[H]
    ...
    \caption{
        The relative free energy referenced to the \ce{Ni4(OH)5(H).4H2O} (blue) structure. Alternative structures are plausible for this structure, suggesting that fluxionality may be important for this particular structure.
    }
...
Figure~\ref{fig:SI-phase_diagram_DFTU} considers the DFT + U correction term. Starting from the converged geometries of the structures appearing on phase diagram (Figure~4 of the main text), the electronic energy was recalculated with the DFT + U formalism to evaluate the influence of U on the phase diagram structures. Figure~\ref{fig:SI-phase_diagram_DFTU} includes the electronic energy from the DFT + U calculation and the vibrational contributions to the free energy. We selected U and J parameters for \ce{NiO2} according to \textit{Database of Hubbard U and J Values for TMOs}\cite{Hubbard_parameter_website} as the U and J parameters of the \ce{Ni4} cluster.\cite{Moore2022} We were unable to optimize the geometries for the phase diagram structures due to limitations in the methods (Lowdin population analysis was implemented due to issues converging the electronic structure with Mulliken population analysis) ; therefore, only single point energies are calculated for these structures. 

Large differences in Table~\ref{tbl:alternate_model_energies_DFTU} are observed between $\Delta E_{\text{periodic}}$ and $\Delta E_{\text{DFT + U}}$. These differences cannot be separated into contributions from the +U method versus the energies were computed from unconverged structures (due to now implement the +U method). However, we still construct a phase diagram with these energies from DFT + U combined with the vibrational free energy term that does not provide any new observations or conclusions. The conditions for $\Delta \mu_{\ce{H2}}$ and $\Delta \mu_{\ce{H2O}}$ are expanded from the Figure~4 to evaluate the influence of DFT + U on the phase diagram. A few structures at low \ce{Ni-O} coordination numbers are removed (\ce{Ni4(OH)4} (white) and \ce{Ni4(OH)3(H).H2O} (magenta)). However, all structures with \ce{Ni-O} above 3.25 remain, which are the structures that are in better agreement based on the experimentally observed \ce{Ni-O} coordination numbers. This finding suggests minimal influence of DFT + U on the free energy landscape for these \ce{Ni4} clusters. 
...
\centering
  ...
  \begin{tabular}{lccccc}
    \hline
        Structure &
        \thead{$E_{\text{config}}$ \\ (hartree)} &
        \thead{$E_{\text{config-rH2O}}$ \\ (hartree)} & 
        \thead{$\Delta E_{\text{rel}}$ \\ (kJ/mol)\textsuperscript{a,b}} &
        \thead{$\Delta E_{\text{transfer}}$ \\ (kJ/mol)\textsuperscript{c}} &
        \thead{$\Delta E_{\text{\ce{H2O}}}$ \\ (kJ/mol)\textsuperscript{d,e}} \\
        \hline
        \ce{Ni4(OH)6.4H2O} (green)             & -4846.6895 &    -         &      -  &    -    &    -   \\
        \ce{Ni4(OH)6.3H2O} (purple)            & -4829.4227 &    -         &      -  &    -    &    -   \\
        \ce{Ni4(OH)6.3H2O}-config1             & -4846.6844 &  -4829.4161  &   -13.4 &    4.1  & -126.3 \\
        \ce{Ni4(OH)6.3H2O}-config2             & -4846.6873 &  -4829.4429  &    -5.7 &  -58.6  &  -63.6 \\
        \ce{Ni4(OH)6.3H2O}-config3             & -4846.6864 &  -4829.4444  &    -8.1 &  -65.0  &  -57.2 \\
        \hline
    \end{tabular} \\
    \textsuperscript{a}Reference: \ce{Ni4(OH)6.4H2O} (green) \\
    \textsuperscript{b} \ce{Ni4(OH)6.3H2O}\text{-config} \ce{->[$\Delta E_{\text{rel}}$]} \ce{Ni4(OH)6.4H2O} \\ 
    \textsuperscript{c}\ce{Ni4(OH)6.3H2O}-config + \ce{Ni4(OH)6.3H2O} \ce{->[$\Delta E_{\text{transfer}}$]} \ce{Ni4(OH)6.3H2O}-config-rH2O + \ce{Ni4(OH)6.4H2O} \\
    \textsuperscript{d}\ce{Ni4(OH)6.3H2O}-config-rH2O + E \ce{->[$\Delta E_{\text{\ce{H2O}}}$]} \ce{Ni4(OH)6.3H2O}-config \\
    \textsuperscript{e}$E_{\ce{H2O}}=-17.2202$ hartree
\end{table}    
% \end{center}
...
\centering
  ...
  \begin{tabular}{lccccc}
    ...
    \thead{$\Delta E_{\text{\ce{H2O}}}$ \\ (kJ/mol)\textsuperscript{d,e}} \\
        \hline
        \ce{Ni4(OH)6.3H2O} (purple)  & -4829.4227 &        -      &   -   &    -     &    -  \\
        \ce{Ni4(OH)6.2H2O} (cyan)    & -4812.1716 &        -      &   -   &    -     &    -  \\
        \ce{Ni4(OH)6.2H2O}-config1   & -4829.4323 &   -4812.1908  &  25.0 &  -25.4   & -55.9 \\
        \ce{Ni4(OH)6.2H2O}-config2   & -4829.4290 &   -4812.1907  &  16.4 &  -34.0   & -47.3 \\
        \ce{Ni4(OH)6.2H2O}-config3   & -4829.4363 &   -4812.1981  &  35.7 &  -34.0   & -47.2 \\
        \hline
    \end{tabular} \\
    \textsuperscript{a}Reference: \ce{Ni4(OH)6.3H2O} (purple) \\
    \textsuperscript{b}$\Delta E = E_{\ce{Ni4(OH)6.3H2O}} - E_{\ce{Ni4(OH)6.2H2O}\text{-config}}$ \\ 
    \textsuperscript{c}\ce{Ni4(OH)6.2H2O}-config + \ce{Ni4(OH)6.2H2O} \ce{->[$\Delta E_{\text{transfer}}$]} \ce{Ni4(OH)6.2H2O}-config-rH2O + \ce{Ni4(OH)6.3H2O} \\
    \textsuperscript{d}\ce{Ni4(OH)6.2H2O}-config-rH2O + \ce{H2O} \ce{->[$\Delta E_{\text{\ce{H2O}}}$]} \ce{Ni4(OH)6.2H2O}-config \\
    \textsuperscript{e}$E_{\ce{H2O}}=-17.2202$ hartree
\end{table}    
\end{center}
...
\centering
  ...
  \begin{tabular}{lcccc}
    \hline
    Structure &
    \thead{Electronic Energy \\ (hartree)} &
    \thead{$E_{\text{config-rH2O}}$ \\ (hartree)} & 
    \thead{$\Delta E_{\text{rel}}$ \\ (kJ/mol)\textsuperscript{a,b}} &
    \thead{$\Delta E_{\text{\ce{H2O}}}$ \\ (kJ/mol)\textsuperscript{c,d}} \\
        \hline
        \ce{Ni4(OH)6.1H2O} (teal)        & -4794.9465 &      0.0     &       -  &    -    \\
        \ce{Ni4(OH)6}-config1 (white)    & -4794.9327 &  -4777.6987  &   -36.2  &   -36.2 \\
        \ce{Ni4(OH)6}-config2 (white)    & -4794.9380 &  -4777.7040  &   -22.3  &   -36.3 \\
        \ce{Ni4(OH)6}-config3 (white)    & -4794.9433 &  -4777.6995  &    -8.4  &   -62.1 \\
        \hline
    \end{tabular} \\
    \textsuperscript{a}Reference: \ce{Ni4(OH)6.1H2O} (teal) \\
    \textsuperscript{b}$\Delta E = E_{\ce{Ni4(OH)6.1H2O}} - E_{\ce{Ni4(OH)6}\text{-config}}$ \\  
    \textsuperscript{c}\ce{Ni4(OH)6}-config-rH2O + \ce{H2O} \ce{->[$\Delta E_{\text{\ce{H2O}}}$]} \ce{Ni4(OH)6}-config \\
    \textsuperscript{d}$E_{\ce{H2O}}=-17.2202$ hartree    
\end{table}    
\end{center}

Tables~\ref{tbl:water_selection_energies_green} to \ref{tbl:water_selection_energies_teal} show the relative energies of structures with the same overall stoichiometry, but different \ce{Ni_4} clusters. A single, hydrogen bonded \ce{H2O}-ligand was moved from the \ce{OH}/\ce{H2O} ligand pairs on an adjacent node to the \ce{Ni4} cluster to capture the thermodynamics of \ce{H2O}-ligands interchanging from the node and the cluster. We simulate different configurations to account for \ce{H2O}-ligand placement on the node (Figure~\ref{fig:SI-H2O_node_to_ligand}). $\Delta E < 0$ indicates \ce{H2O} ligand on the node is more favorable, whereas $\Delta E > 0$ indicate the \ce{H2O} ligand on the cluster is more favorable. The results presented in Tables~\ref{tbl:water_selection_energies_green} to \ref{tbl:water_selection_energies_teal} suggest that in some circumstances \ce{H2O} moving from the node to the cluster is thermodynamically favorable. Additionally, $E_{\text{\ce{H2O}}}$ represents the \ce{H2O} binding energy of the free \ce{H2O} ligand anchored to the node (as shown in Tables~\ref{tbl:water_selection_energies_green} to \ref{tbl:water_selection_energies_teal}). The average $E_{\text{\ce{H2O}}}$ for free a \ce{H2O} ligand hydrogen bonding the accessible \ce{-OH}/\ce{-OH2} ligands of an adjacent node is -59.1 kJ/mol. 
