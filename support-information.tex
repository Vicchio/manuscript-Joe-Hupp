...
\centering
  ...
  \begin{tabular}{lcccc}
    \hline
        ...
        i) \ce{Ni4(H)4} (red)              &  \hl{XXX} & \hl{XXX} \\
        j) \ce{Ni4} (gray)                 &  40.603 &15.982  \\
        \hline
    \end{tabular} \\
    \textsuperscript{a} Fixed Unit Cell: \hl{XXX} \\
    \textsuperscript{b} Variable Unit Cell: \hl{XXX}  \\
\end{table}    
\end{center}
...
\centering
  ...
  \begin{tabular}{lcccc}
    \hline
        Structure  & \thead{Fixed Unit Cell\textsuperscript{a} \\ Electronic \\ Energy (hartree)} &  \thead{ Variable Unit Cell\textsuperscript{b} \\ Electronic \\ Energy (hartree)} &   \thead{ $\Delta$Electronic \\ Energy (kJ/mol)} \\ % HI MOM
        \hline
        ...
        i) \ce{Ni4(H)4} (red)             & \hl{XXX}   & \hl{XXX}   & \hl{XXX} &  \\
