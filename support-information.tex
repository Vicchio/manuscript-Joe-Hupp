...
\begin{figure}[H]
    ...
    % \includegraphics[width=0.60\textwidth]{zi-images/04-SI-images/SI-heat_map_red.png}
    \caption{
        Heat map for the... showing $\Delta \Delta F^{(2)}$ as a function of $\Delta \mu_{\ce{H2O}}$ and $\Delta \mu_{\ce{H2}}$.
    }
